                        ...
                        <div class="user_heading">
                            ...
                            <div class="user_heading_content" style="float:left">
                             ...
                             <div class="user_heading_avatar" style="background-image:none;float:right;">
                                <img class="" src="<?php echo base_url()?>upload/<?php echo $records2[0]['image'];?>" alt="user avatar" style="border-radius:0px; width:100%; max-width:300px; height:100%; max-height:200px;background-image:none;" >
                            </div>
                            <a class="md-fab md-fab-small md-fab-accent" href="<?php echo site_url()?>profile/contactprofile/<?php echo $records4[0]['cp_id'];?>">
                                            ...
                                            <ul class="md-list md-list-addon">
                                                <li>
                                                    ...
                                                    <div class="md-list-content">
                                                        ...
                                                        <span style="float:right;position:relative;bottom:30px;">Verified<i class="material-icons" style="color:green">&#xE8E8;</i></span>
                                                    </div>
