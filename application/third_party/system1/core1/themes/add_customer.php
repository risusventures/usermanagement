   ...
   <?php include('header_top.php');?>
    <div id="page_content" style="margin-left:0px;">
        <div id="page_content_inner">
            <h3 class="heading_b uk-margin-bottom"> Add New Customer</h3>
            <div class="md-card">
             ...
             { echo '<div class="uk-alert uk-alert-success" data-uk-alert="">
                    ...
                    <form id="form_validation"   name="contactform" id="contactform" onsubmit="return validateentry();"  class="uk-form-stacked" action="<?php echo base_url();?>seller/customer" enctype="multipart/form-data" Method="post">
                        <div class="uk-grid " data-uk-grid-margin>
                            <div class="uk-width-medium-1-3">
                                <div class="parsley-row">
                                    <label for="fullname">Company Name<span class="req">*</span></label>
                                    <input type="text" name="customer_company"  class="md-input" value=""/>
                                </div>
                            </div>
                                <div class="uk-width-medium-1-3">
                                <div class="parsley-row">
                            ...
                            <div class="uk-width-medium-1-3">
                                <div class="parsley-row">
                                    ...
                                    <input type="text" name="customer_email" class="md-input"  value=""/>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="uk-width-medium-1-3">
                                <div class="parsley-row">
                                    ...
                                    <input type="number" name="customer_phone"  class="md-input" value=""/>
                                </div>
                            </div>
                                <div class="uk-width-medium-1-3">
                                <div class="parsley-row">
                            ...
                            <div class="uk-width-medium-1-3">
                                <div class="parsley-row">
                                    ...
                                    <input type="number" name="customer_postal_code" class="md-input"  value=""/>
                                </div>
                            </div>
                        </div>
