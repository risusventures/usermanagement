...
<body class=" sidebar_main_open sidebar_main_swipe">
   ...
   <?php include('header_top.php');?>
    ...
    <a href="#" class="uk-alert-close uk-close"></a>Upload Product Successfully......</div>';}?>
	<?php echo form_open(base_url('seller/Products'),array('id'=>'contactname','name'=>'contactname','class'=>'uk-form-stacked','onsubmit'=>'return validateentry();','enctype'=>'multipart/form-data' ));?>
    ...
    <img src="<?php echo base_url()?>assets/img/dummy123.png" alt="user avatar" style="background-image:none;height:100px;width:100px;border-radius: 0px;"/>
          </div>
          <div class="fileinput-preview fileinput-exists thumbnail" style="radius:0px;"></div>
                                    ...
                                    <div class="user_avatar_controls">
                                        <span class="btn-file">
                                            ...
                                            <input type="file" name="image" id="user_edit_avatar_control" onchange="check_upload(this)" style="">
                                        </span>
        ...
        <span class="uk-input-group-addon" style="padding:0px;">
        <b id="head1" onClick="showDiv1()">&nbsp;<i class="material-icons" style="font-size: 30px;color: rgb(25, 118, 210);padding-bottom: 5px;">&#xE89C;</i></b> 
                                </span>
                            </div>
                        </div>
                        </div>
                  ...
                  <div class="uk-width-1-1">
                                <div class="parsley-row">
                                <div class="md-input-wrapper "><label for="message">Description</label><textarea  style="overflow-x: hidden;  height: 21px;" class="md-input autosize_init md-input-success" name="description" cols="10" rows="8"  style="height:auto;"></textarea><span class="md-input-bar"></span></div>    
