        ...
        if ($this->session->userdata('logged_in')) {
            ...
            if ($this->form_validation->run() == FALSE) {
                ...
                if ($this->profile_model->contact_model($data) == TRUE) {
                    ...
                    redirect('profile/contactprofile?message=already');
                }
            }
        } else {
            //If no session, redirect to login page
