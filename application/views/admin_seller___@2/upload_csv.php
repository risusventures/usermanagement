...
<body class=" sidebar_main_open sidebar_main_swipe">
    ...
    <a href="#" class="uk-alert-close uk-close"></a>Upload file Successfully......</div>';}?>
                <div class="md-card-content">
					...
					<br>
					<?php echo form_open(base_url('seller/csv'),array('id'=>'contactform','name'=>'contactform','onsubmit'=>'return validateentry();','class'=>'uk-form-stacked','enctype'=>'multipart/form-data'));?>	  
                    <div class="uk-grid">
