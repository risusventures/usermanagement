...
<body class=" sidebar_main_open sidebar_main_swipe">
   ...
   <?php include('header_top.php');?>
	...
	<?php echo form_open(base_url('seller/Products'),array('id'=>'contactform','name'=>'contactform','onsubmit'=>'return validateentry();','class'=>'uk-form-stacked','enctype'=>'multipart/form-data'));?>
