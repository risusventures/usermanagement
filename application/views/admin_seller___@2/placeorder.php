                ...
                <!--<input type="text" class="form-control" id="companyName" placeholder="Company Name" name="buyer_company_name" value="<?php echo $row['company_name'];?>"  readonly>-->
                    <b> <p>Principal Assigned Customer</p></b>
                               ...
                               ?>   
                                      ...
                                      <div name="pcheck[]"  class="ptable" id="table<?php echo $principal['Principal_id'];?>" style="display:none;" >
                                          <?php
                                          ...
                                          <label ><input type="checkbox" name="productcheck[]"  class="productcheck" id="mytable<?php echo $singalproducts['cid'];?>" onclick="showproduct()"  value="<?php echo $singalproducts['cid'] ?>" ><?php  $customer_name = $singalproducts['cid'];    $query = $this->db->query("SELECT `customer_person` FROM `customers` WHERE `customer_id`= '$customer_name'");  $data1 =$query->row_array();   echo $data1['customer_person']; ?></label>
                                          <br>
                                ...
                                <div class="form-group">
                                   ...
                                   ?>
                                    ...
                                    <table class="producttable"  style="display:none" id="tables<?php echo $customerp_id['cid'];?>">
                                         <caption style=" font-size: 20px;font-weight: bold;text-align: left;"><?php echo $customerp_id['cid'];?></caption>
                                         <thead>
                                            <tr>
                                                <th>Products</th>
                                                <th>Price</th>
                                            ...
                                            <tbody>
                                              ...
                                              <tr>
                                                    <td><?php echo $customerp_id['product_id']; ?><?php  echo'<pre>'; print_r($customerp_id);echo'</pre>';?></td>
                                                    <td><input type="text"  value="<?php echo  $singalproducts ['product_price']; ?>" readonly name="price"></td>
