                    ...
                    <div class="md-card">
                        <div class="user_heading">
                            ...
                            <div class="user_heading_content" style="float:left">
                                <h2 class="heading_b uk-margin-bottom"><span class="uk-text-truncate" style="  text-transform: capitalize;"><?php echo $records4[0]['company_name'];?><span class="sub-heading1" style="font-size:17px;text-transform: capitalize;">       <?php echo $records4[0]['city'];?></span></span></h2>
                                <ul class="user_stats">
                                    <li>
                                        <h4 class="heading_a"><?php echo $records[0]['cat']; ?><span class="sub-heading">Total Category</span></h4>
                                    </li>
                                    <li>
                                        <h4 class="heading_a"><?php echo $records1[0]['pro']; ?><span class="sub-heading">Total Product</span></h4>
                                    </li>
                                    <li>
                             ...
                             <div class="user_heading_avatar" style="background-image:none;float:right;">
                                <img class="" src="<?php echo base_url()?>assets/file_icon/profile_image/thum/<?php if($records2[0]['image']){ echo $records2[0]['image'];}else{ echo 'dummy1.jpg';};?>" alt="user avatar" style="border-radius:0px; width:100%; max-width:300px; height:100%; max-height:200px;background-image:none;" >
                            </div>
                        ...
                        <div class="user_content">
                            <div style="height: 46px;" class="uk-sticky-placeholder"><ul style="margin: 0px;" id="user_profile_tabs" class="uk-tab" data-uk-tab="{connect:'#user_profile_tabs_content', animation:'slide-horizontal'}" data-uk-sticky="{ top: 48, media: 960 }">
                            ...
                            <li aria-expanded="false" aria-haspopup="true" class="uk-tab-responsive uk-active uk-hidden"><a>About</a><div class="uk-dropdown uk-dropdown-small"><ul class="uk-nav uk-nav-dropdown"></ul><div></div></div></li></ul></div>
                            <ul id="user_profile_tabs_content" class="uk-switcher uk-margin">
                                <li class="uk-active" aria-hidden="false">
                                  <p><?php echo $records3[0]['description'];?></p><div class="uk-grid uk-margin-medium-top uk-margin-large-bottom" data-uk-grid-margin="">
                                            ...
                                            <ul class="md-list md-list-addon">
                                                <li>
                                                    ...
                                                    <div class="md-list-content">
                                                        ...
                                                        <span style="float:right;position:relative;">Verified<i class="material-icons" style="color:green">&#xE8E8;</i></span>
                                                    </div>
                                        ...
                                        <div class="uk-width-large-1-2">
                                            <h4 class="heading_c uk-margin-small-bottom">Invoice</h4>
                                            <ul class="md-list">
                                                <li>
                                                    <div class="md-list-content">
                ...
                <div>
                   <div class="md-card md-card-hover " style="background-color:#f88529">
                    ...
                    <div class="md-card-content uk-flex uk-flex-center uk-flex-middle">
                     <span style="font-size:35px;color:white"><b style="font-size:17px;"><i class="material-icons" style="font-size:27px;color:white"></i><br>Sales</b></span></span>
                        </div></a>
                    </div>
                </div>
                <div>
                <div class="md-card md-card-hover" style="background-color: rgba(0, 128, 0, 0.68);">
                     <a href="<?php echo base_url();?>seller/view_order" style='text-decoration:none;'>  
                        <div class="md-card-content uk-flex uk-flex-center uk-flex-middle">
                         <span style="font-size:35px;color:white;"><b style="font-size: 17px;"><i class="material-icons" style="font-size:27px;color:white">shopping_cart</i><br>Invoices</b></span>
                        </div></a>
                    </div>
                </div>
                <div>
                           ...
                           <div class="md-card md-card-hover" style="background-color:#1976D2;">
                              <a href="<?php echo base_url();?>seller/list_customers" style='text-decoration:none;'> 
                        <div class="md-card-content uk-flex uk-flex-center uk-flex-middle">
                         <span style="font-size:35px;color:white;"><b style="font-size:17px;"><i class="material-icons" style="font-size:27px;color:white">group</i><br>Customers</b></span>
                        </div></a>
                    </div>
                </div>
                <div>
                 <div class="md-card md-card-hover" style="background-color:#52B9E9;">
                <a href="<?php echo base_url();?>seller/password" style='text-decoration:none;'> 
                        <div class="md-card-content uk-flex uk-flex-center uk-flex-middle" style="background-color: rebeccapurple">
                         <span style="font-size:35px;color:white"><b style="font-size:17px;"><i class="material-icons" style="font-size:27px;color:white">&#xE0DA;</i><br>Password</b></span>
                        </div></a>
                     </div>
                    </div>
                  </div>
