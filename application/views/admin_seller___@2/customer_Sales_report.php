                ...
                <div class="md-card-content">
                    <div class="uk-grid" data-uk-grid-margin="">
                        <div class="uk-width-medium-5-10">
                            <div class="md-input-wrapper"><h2>Customer Sales Report</h2><?php if(isset($_GET['submit'])){  echo '<strong>Date : '.$start_date.'&nbsp;To&nbsp;'.$end_date.'</strong><br><br> Company Name : '.$customer_records[0]['customer_company'].'<br> Email : '.$customer_records[0]['customer_email'].'<br>Phone : '.$customer_records[0]['customer_phone'];}?></div><?php foreach($start_date as $start){ echo $start;}?>
                        </div>
						<div class="uk-width-medium-2-10">
                            <div class="md-input-wrapper">
							<select style="width:100%;height:34px;border-radius: 5px;margin-top: 4px;" class="buyer"  name="customer_company_name" required>
							...
							<input type="text"  class="seller_email" style="width:100%;height:25px;border-radius: 5px;margin-top: 4px;" Placeholder="Please Enter Email" required="required">
							</div>
                        </div>
                        <div class="uk-width-medium-3-10">
                         <div class="md-input-wrapper"> <input class="raw" id="e1" name="chart_filter"  style="height:50px;font-size:15px;" required="required"><input type="submit" class="md-btn md-btn-primary uk-margin-small-top" style="margin-left:30px;" value="Filter" name="submit"/></div>
                        </div>
                    </div>
    <?php echo form_close();?>
                </div>
            </div>
            <div class="uk-grid uk-grid-width-large-1-6 uk-grid-width-medium-1-2 uk-grid-medium uk-sortable sortable-handler" data-uk-sortable="" data-uk-grid-margin="">
                <div style="">
                    <div class="md-card">
                        <div class="md-card-content">
                            ...
                            <h2 class="uk-margin-remove"><span class="uk-icon-inr" style="font-size: 20px;">&nbsp;<?php foreach($total_sales as $sales){$total = $sales['total_amount']; if($total){echo number_format($total,2);}else{ echo number_format(0,2);}}?></span></h2>
                        </div>
                    </div>
                </div>
                <div style="">
                    <div class="md-card">
                        <div class="md-card-content">
							...
							foreach($records as $key){ $invoice_id = $key['id'];
							...
							} if($sum){ echo $sum;}else{ echo number_format(0,2);}?></span></h2>
                        </div>
                    </div>
                </div>
                <div style="">
                    <div class="md-card">
                        <div class="md-card-content">
                            <div class="uk-float-right uk-margin-top uk-margin-small-right"><span class="peity_orders peity_data" style="display: none;">64/100</span><svg class="peity" height="24" width="24"><path d="M 12 0 A 12 12 0 1 1 2.7538410866905263 19.649087876984275 L 7.376920543345263 15.824543938492138 A 6 6 0 1 0 12 6" fill="#8bc34a"></path><path d="M 2.7538410866905263 19.649087876984275 A 12 12 0 0 1 11.999999999999998 0 L 11.999999999999998 6 A 6 6 0 0 0 7.376920543345263 15.824543938492138" fill="#eee"></path></svg></div>
                            <span class="uk-text-muted uk-text-small">Total Pending</span>
                            <h2 class="uk-margin-remove"><span class="uk-icon-inr" style="font-size: 20px;">&nbsp;<?php foreach($total_pending as $sales){echo number_format($sales['pending_amount'],2);}?></span></h2>
                        </div>
                    </div>
                </div>
                <div style="">
                    <div class="md-card">
                        <div class="md-card-content">
                            <div class="uk-float-right uk-margin-top uk-margin-small-right"><span class="peity_live peity_data" style="display: none;">2,5,3,9,6,5,9,7,3,5,2,2,7,7,1,8,2,6,7,6</span><svg class="peity" height="28" width="64"><polygon fill="#efebe9" points="0 27.5 0 21.5 3.3684210526315788 12.5 6.7368421052631575 18.5 10.105263157894736 0.5 13.473684210526315 9.5 16.842105263157894 12.5 20.210526315789473 0.5 23.57894736842105 6.5 26.94736842105263 18.5 30.31578947368421 12.5 33.68421052631579 21.5 37.05263157894737 21.5 40.421052631578945 6.5 43.78947368421052 6.5 47.1578947368421 24.5 50.526315789473685 3.5 53.89473684210526 21.5 57.263157894736835 9.5 60.63157894736842 6.5 64 9.5 64 27.5"></polygon><polyline fill="none" points="0 21.5 3.3684210526315788 12.5 6.7368421052631575 18.5 10.105263157894736 0.5 13.473684210526315 9.5 16.842105263157894 12.5 20.210526315789473 0.5 23.57894736842105 6.5 26.94736842105263 18.5 30.31578947368421 12.5 33.68421052631579 21.5 37.05263157894737 21.5 40.421052631578945 6.5 43.78947368421052 6.5 47.1578947368421 24.5 50.526315789473685 3.5 53.89473684210526 21.5 57.263157894736835 9.5 60.63157894736842 6.5 64 9.5" stroke="#5d4037" stroke-width="1" stroke-linecap="square"></polyline></svg></div>
                            <span class="uk-text-muted uk-text-small">Total Due</span>
                            <h2 class="uk-margin-remove" id="peity_live_text"><span class="uk-icon-inr" style="font-size: 20px;">&nbsp;<?php if($total > $sum){ echo number_format($total-$sum,2);}else {echo  number_format(0,2);}?></span></h2>
                        </div>
                    </div>
                </div>
                    <div style="">
                    <div class="md-card">
                        <div class="md-card-content">
                            ...
                            <h2 class="uk-margin-remove" id="peity_live_text"><span class="uk-icon-inr" style="font-size: 20px;">&nbsp;<?php if($total< $sum){ echo number_format($sum-$total,2);}else{ echo number_format(0,2);}?></span></h2>
                        </div>
                    </div>
                </div>
                    <div style="">
                    <div class="md-card">
                        <div class="md-card-content">
                            ...
                            <h2 class="uk-margin-remove" id="peity_live_text"><span class="uk-icon-inr" style="font-size: 20px;">&nbsp;<?php foreach($total_canceled as $sales){echo number_format($sales['canceled_amount'],2);} ?></span></h2>
                        </div>
                    </div>
                </div>
            </div>
...
<div class="md-card uk-margin-medium-bottom">
                     ...
                     <table class="uk-table uk-table-align-vertical uk-table-nowrap tablesorter tablesorter-altair" id="ts_pager_filter">
                            ...
                            <tr><td></td>
                                ...
                                $b=$paid_balance->result_array();foreach($b as $paid_balance){ if($paid_balance['paid_balance']){echo $paid_balance['paid_balance'].'.00';}else{echo '0.00';}}?></p></td>
                                <td><p class="uk-icon-inr">&nbsp;<?php  if(Key['Total_amount']){ echo $key['Total_amount']-$paid_balance['paid_balance'].'.00';}?></p></td>
                                <td><?php echo $key['status'];?></td>
                                <td><i class="material-icons">person</i>&nbsp;<?php echo $key['sales_person']; echo $records['total_sales1'];?></td>
                            </tr>
                            <?php $i++;} ?>
                            </tbody>
                        </table>
