            ...
            <div class="md-card">
             ...
             { echo '<div class="uk-alert uk-alert-success" data-uk-alert="">
                    <a href="#" class="uk-alert-close uk-close"></a>Added Principal Successfully......</div>';}?>
						<?php echo form_open(base_url('seller/update_customer'),array('id'=>'saveprincipal','name'=>'saveprincipal','onsubmit'=>'return validateentry();','class'=>'uk-form-stacked','enctype'=>'multipart/form-data'));?>
                        <div class="uk-grid " data-uk-grid-margin>
                            <input type="hidden" name="uid" class="md-input label-fixed" value="<?php echo $edit_customer['cust']['customer_id'];?>" data-parsley-id="4">
                                <div class="uk-width-1-3">
                                <div class="parsley-row">
                                    <label for="fullname">Company Name<span class="req">*</span></label>
                                    <input type="text" required="required" name="customer_person"  class="md-input" value="<?php echo $edit_customer['cust']['customer_person'] ?>" />
                                </div>
                            </div>
                            <div class="uk-width-1-3" style="margin-top: 9px;" >
                                <div class="parsley-row">
                                    <label for="short">Short Name<span class="req">*</span></label>
                                    <input type="text" required="required"  name="short_name" class="md-input"  value="<?php echo $edit_customer['cust']['short_name'] ?>"/>
                                </div>
                            </div>
                            <div class="uk-width-1-3" style="display:none;">
                                <div class="parsley-row">
                                    <label for="email">Email Address<span class="req">*</span></label>
                                    <input type="text" name="customer_email" class="md-input"  value="<?php echo $edit_customer['cust']['Principal_email'] ?>"/>
                                </div>
                            </div>
                            <div class="uk-width-1-3" style="margin-top: 10px;">
                                <div class="parsley-row">
                                    <label for="fullname">Phone<span class="req">*</span></label>
                                    <input type="text" required="required" name="customer_phone"  class="md-input" value="<?php echo $edit_customer['cust']['customer_phone'] ?>"/>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="parsley-row">
                                    ...
                                    <input type="text" required="required" name="customer_address"  class="md-input" value="<?php echo $edit_customer['cust']['customer_address'] ?>" />
                                </div>
                            </div>
                            ...
                            <div class="uk-width-medium-1-3">
                                <div class="parsley-row">
                                    ...
                                    <input type="text" required="required" name="customer_state" class="md-input"  value="<?php echo $edit_customer['cust']['customer_state'] ?>"/>
                                </div>
                            </div>
                            ...
                            <div class="uk-width-medium-1-3">
                                <div class="parsley-row">
                                    ...
                                    <input type="text" required="required" name="customer_city" class="md-input"  value="<?php echo $edit_customer['cust']['customer_city'] ?>"/>
                                </div>
                            </div>
                            ...
                            <div class="uk-width-medium-1-3">
                                <div class="parsley-row">
                                    ...
                                    <input type="text" required="required" name="customer_country"  class="md-input" value="<?php echo $edit_customer['cust']['customer_country'] ?>" />
                                </div>
                            </div>
                            ...
                            <div class="uk-width-medium-1-3">
                                <div class="parsley-row">
                                    ...
                                    <input type="text"  name="customer_postal_code" class="md-input"  value="<?php echo $edit_customer['cust']['customer_postal_code'] ?>"/>
                                </div>
                            </div>
                        </div>
                    ...
                    <div id="reapeat1" style="margin-top: 20px">
                        ...
                        <?php if(!empty($edit_customer['customers_contacts'])){
                            ...
                            <div class="uk-width-1-3">
                             ...
                             <div class="uk-width-1-3">
                                  <h2>Email</h2>
                                    <label for="email">Email<span class="req">*</span></label>
                                    <input type="text"  name="contactper[email][]" style="padding-top: 25px;" class="md-input"  value=""/>
                                </div>
                            </div>
                      ...
                      <div class="uk-grid" style="margin-top: 20px">
                            <div class="uk-width-1-1">
                                <button type="button" class="md-btn md-btn-success" onclick="add_more()" name="add" >Add More Contact</button>
                            </div>
                                ...
                                <div class="parsley-row">
                                    ...
                                    foreach ($list_principal as $principal) { 
                                     ...
                                     <div class="checkbox">
                                         ...
                                         <label><input type="checkbox" name="pcheck[]" <?php if(in_array($principal['Principal_id'],$selected_princ)){ ?> checked="checked" <?php } ?>   class="pcheck" onclick="showprincple()"  id="mytable<?php echo $principal['Principal_id'];?>" value="<?php echo $principal['Principal_id'] ?>"><?php echo $principal['Principal_person'];?></label>
                                        </div>
                                    <?php                                        
                                    }
...
//                                       echo '<pre>';print_r($data);echo '</pre>'; 
            ...
            <tr>
                  ...
                  <td>
                      ...
                      <input type="text"  value="<?php if(isset($price_array[$principalid][$singalproducts['id']])){ echo  $price_array[$principalid][$singalproducts['id']];} ?>"  name="price[<?php echo $principalid ?>][<?php echo $singalproducts['id'] ?>]">
                  
                  </td>
                  <td>
                      <input type="hidden" name="commissionid[<?php echo $principalid ?>][<?php echo $singalproducts['id'] ?>]"
                          value="<?php if(isset($customers_principal_assigned_ids[$principalid][$singalproducts['id']])){ echo  $customers_principal_assigned_ids[$principalid][$singalproducts['id']];} ?>"   
                             />
                      <input type="text" name="commission[<?php echo $principalid ?>][<?php echo $singalproducts['id'] ?>]"
                             value="<?php if(isset($commission_array[$principalid][$singalproducts['id']])){ echo  $commission_array[$principalid][$singalproducts['id']];} ?>" >

                  </td>
                  
                   <td>
                        <select name="currency[<?php echo $principalid ?>][<?php echo $singalproducts['id'] ?>]">
                            <option <?php if($currency_array[$principalid][$singalproducts['id']]=="usd"){ ?> selected="selected"<?php } ?> value="usd">USD</option>
                            <option <?php if($currency_array[$principalid][$singalproducts['id']]=="eur"){ ?> selected="selected"<?php } ?> value="eur">EURO</option>
                        </select>                                                         
...
function principal_contacts(id){    
    $.ajax({
            ...
            url: '<?php echo base_url('seller/del_contacts?id=')?>'+id,
