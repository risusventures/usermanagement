...
<input type="hidden" name="uid" class="md-input label-fixed" value="<?php echo $item['id'];?>" data-parsley-id="4">				  
 ...
 <div class="md-input-wrapper md-input-filled"><label>Item Name<span class="req">*</span></label><input type="text" name="item_name" class="md-input label-fixed" value="<?php echo $item['item_name'];?>" data-parsley-id="4"  required><span class="md-input-bar"></span></div> 
                ...
                <?php echo form_close();?>
                     ...
                     <a href="<?php echo base_url()?>seller/delete_item/<?php echo $item['id'];?>" onclick="return ConfirmDialog()" data-uk-tooltip="{pos:'bottom'}" Title="Delete" onclick="return ConfirmDialog()"><i class="material-icons" style="font-size:28px;color:#1976D2;"></i></a> &nbsp;
