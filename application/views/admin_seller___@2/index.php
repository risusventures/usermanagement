 ...
 <?php  if(isset($_GET['email'])) { echo '<div class="uk-alert uk-alert-success" data-uk-alert="">
        ...
        <div class="md-card" id="login_card">
            <div class="md-card-content large-padding" id="login_form">
              ...
              <div class="user_avatar" style="background-image:url(<?php //echo base_url()?>assets/img/risus-03.png); height:165px; width:100%; background-color:white;">
                  <img src="<?php echo base_url()?>assets/img/risus-03.png">
               
              </div>
                </div>
                <?php echo form_open(base_url(),array('id'=>'login','method'=>'post','role'=>'form')) // echo form_open(base_url('user_ctrl/login'),array('id'=>'login','method'=>'post','role'=>'form'))?>
                    ...
                    <div class="uk-margin-medium-top">
                       <a href="javascript:;" >  <input type="submit" name="submit" value="Sign In" class="md-btn md-btn-primary md-btn-block md-btn-large"></a>
                    </div>
                    <?php echo form_close();?>
