...
<h4 class="heading_a uk-margin-bottom">View All Drinks and Beverages Items</h4>
            <div class="md-card">
				...
				<div class="md-card-content">
				   ...
				   <div class="uk-overflow-container uk-margin-bottom">
                        <table class="uk-table uk-table-align-vertical uk-table-nowrap tablesorter tablesorter-altair" id="ts_pager_filter">
                            ...
                            <tbody>
                     <?php  $i=1; foreach ($drink_items as $item) {?>  
                     <tr>
					 <td><?php echo $i++;?></td>
                     <td><?php echo $item['item_name']; ?></td>
                     <td>
 <a href="#" data-uk-tooltip="{pos:'bottom'}" Title="edit" data-uk-modal="{target:'#modal_header_footer_<?php echo $item['id']; ?>'}"><i class="material-icons" style="font-size:28px;color:#1976D2;"></i></a>
<div class="uk-modal" id="modal_header_footer_<?php echo $item['id']; ?>" aria-hidden="true" style="display: none; overflow-y: auto;"> 
	<?php echo form_open(base_url('seller/update_drinkitem'),array('id'=>'contactname','name'=>'contactname','class'=>'uk-form-stacked','enctype'=>'multipart/form-data' ));?>	                 
<input type="hidden" name="uid" class="md-input label-fixed" value="<?php echo $item['id'];?>" data-parsley-id="4">				  
 ...
 <div class="md-input-wrapper md-input-filled"><label>Item Name<span class="req">*</span></label><input type="text" name="item_name" class="md-input label-fixed" value="<?php echo $item['item_name'];?>" data-parsley-id="4"  required><span class="md-input-bar"></span></div> 
 </div></div>
                ...
                <?php echo form_close();?>
                     ...
                     <a href="<?php echo base_url()?>seller/delete_drinkitem/<?php echo $item['id'];?>" onclick="return ConfirmDialog()" data-uk-tooltip="{pos:'bottom'}" Title="Delete" onclick="return ConfirmDialog()"><i class="material-icons" style="font-size:28px;color:#1976D2;"></i></a> &nbsp;
	...
	<?php echo form_open(base_url('seller/drinkitem_submit'),array('id'=>'contactname','name'=>'contactname','class'=>'uk-form-stacked','enctype'=>'multipart/form-data' ,'onsubmit'=>'return validateentry();'));?>	  
				   <div class="uk-modal-dialog" style="top: 88px;">
