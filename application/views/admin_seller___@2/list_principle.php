...
<?php include('header_top.php');?>
    <div id="page_content" style="margin-left:0px;">
        <div id="page_content_inner">
            <h3 class="heading_a uk-margin-bottom"><u>View Principal</u></h3>
            <div class="md-card">
            ...
            <!-- circular charts --> <br><br>
				   <div class="uk-overflow-container uk-margin-bottom" style="margin: 10px;">
                        <table class="uk-table uk-table-align-vertical uk-table-nowrap tablesorter tablesorter-altair" id="ts_pager_filter" style="border: 2px solid whitesmoke !important;">
                            ...
                            <tbody>
                     <?php  $i=1; foreach ($list_principal as $principal) {?>  
                     <tr>
					 <td><?php echo $i++;?></td>
                     ...
                     <td>
                         <a href="http://www.risusventures.com/usermanagement/principal/updatePrincipal?id=<?php echo $principal['Principal_id']; ?>" Title="edit"><i class="material-icons" style="font-size:28px;color:#1976D2;">edit</i></a>
 <a href="#" data-uk-tooltip="{pos:'bottom'}" Title="view" data-uk-modal="{target:'#modal_header_footer1_<?php echo $principal['Principal_id']; ?>'}"><i class="material-icons" style="font-size:28px;color:#1976D2;">remove_red_eye</i></a>

 
 <!-----view model---->
    <div class="uk-modal" id="modal_header_footer1_<?php echo $principal['Principal_id']; ?>" aria-hidden="true" style="display: none; overflow-y: auto;"> 
	<?php echo form_open(base_url('Principal/view_Principal'),array('id'=>'contactname','name'=>'contactname','class'=>'uk-form-stacked','enctype'=>'multipart/form-data' ));?>	                 
<input type="hidden" name="uid" class="md-input label-fixed" value="<?php echo $principal['Principal_id'];?>" data-parsley-id="4">				  
				  <div class="uk-modal-dialog" style="top: 88px;">
                            <div class="uk-modal-header"><h3 class="uk-modal-title">Principal Detail</h3></div>
                  ...
                  <div class="uk-grid " data-uk-grid-margin="">
                      <div class="uk-width-medium-1-2">
                       <div class="parsley-row">
                           <div class="md-input-wrapper md-input-filled"><label for="fullname"> <b>MSG ID :</b> <?php echo $principal['short_name'].$principal['Principal_id']; ?></label></div>   
                               </div>
                            </div>  
                    </div>
                        <div class="uk-grid " data-uk-grid-margin="">
 <div class="uk-width-medium-1-2">
 <div class="parsley-row">
 <div class="md-input-wrapper md-input-filled"><label>Company Name<span class="req">*</span></label><input type="text" name="Principal_company" class="md-input label-fixed" readonly value="<?php echo $principal['Principal_person'];?>" data-parsley-id="4"  required><span class="md-input-bar"></span></div> 
 </div></div>
...
<div class="uk-width-medium-1-2">
<div class="parsley-row">
<div class="md-input-wrapper md-input-filled"><label for="fullname">Phone<span class="req">*</span></label><input type="number" name="Principal_phone" class="md-input label-fixed" readonly value="<?php echo $principal['Principal_phone'];?>" data-parsley-id="10"><span class="md-input-bar"></span></div>    
                                </div>
                            </div>
                        </div>
...
<div class="uk-width-medium-1-2">
<div class="parsley-row">
 <div class="md-input-wrapper md-input-filled"><label for="fullname">Address<span class="req">*</span></label><input type="text" name="Principal_address" class="md-input label-fixed" readonly value="<?php echo $principal['Principal_address'];?>" data-parsley-id="12"><span class="md-input-bar"></span></div> </div>
                            </div>
                            <div class="uk-width-medium-1-2">
                                <div class="parsley-row">
             <div class="md-input-wrapper md-input-filled"><label for="email">City<span class="req">*</span></label><input type="text" name="Principal_city" readonly class="md-input label-fixed" readonly value="<?php echo $principal['Principal_city'];?>" data-parsley-id="14"><span class="md-input-bar"></span></div>
...
<!--						    <div class="uk-width-medium-1-2">
                                ...
                                <div class="parsley-row">
                                    <div class="md-input-wrapper md-input-filled"><label for="fullname">Country<span class="req">*</span></label><input type="text" name="Principal_country" readonly class="md-input label-fixed" value="<?php echo $principal['Principal_country'];?>" data-parsley-id="18"><span class="md-input-bar"></span></div>   
                                </div>
                            </div>
                        <div class="uk-width-medium-1-2">
                                <div class="parsley-row">
                                    <div class="md-input-wrapper md-input-filled"><label for="email">Postal Code<span class="req">*</span></label><input type="number" name="Principal_postal_code" readonly class="md-input label-fixed" value="<?php echo $principal['Principal_postal_code'];?>" data-parsley-id="20"><span class="md-input-bar"></span></div>
...
<?php
$abcd= $principal['Principal_id'];
 $query = $this->db->query("select * from principal_contacts where pid= $abcd");
 $principal_contacts = $query->result_array();
 if(!empty($principal_contacts)){
     $a=1;foreach($principal_contacts as $contact){
...
<div class="uk-width-medium-1-2">
                                ...
                                <div class="parsley-row">
                                    <div class="md-input-wrapper md-input-filled"><label for="fullname">Name<span class="req">*</span></label><input type="text" name="Principal_country" readonly class="md-input label-fixed" value="<?php echo $contact['name'];?>" data-parsley-id="18"><span class="md-input-bar"></span></div>   
                                </div>
...
<?php
$abcd= $principal['Principal_id'];
 $query = $this->db->query("select * from principal_products where pid= $abcd");
 $principal_contacts = $query->result_array();
 if(!empty($principal_contacts)){
   $j=1;  foreach($principal_contacts as $contact){?>
...
<div class="uk-width-medium-1-2" style="float:left">
    ...
    <div class="parsley-rowss" style="margin-bottom:20px">
        <h3><?php echo $contact['product_name'];?> </h3>
                                </div>
...
<!--             <div class="uk-width-medium-1-2" style="display:none">
                                <div class="parsley-row">
                                    <div class="md-input-wrapper md-input-filled"><label for="email">Product Price<span class="req">*</span></label><input type="text" name="Principal_postal_code" class="md-input label-fixed" readonly value="<?php echo $contact['product_price'];?>" data-parsley-id="20"><span class="md-input-bar"></span></div>
...
<!--						      <div class="uk-width-medium-1-1">
    ...
    <!----view modelend --->
                     ...
                     <a href="<?php echo base_url()?>Principal/delete_principal/<?php echo $principal['Principal_id'];?>" onclick="return ConfirmDialog()" data-uk-tooltip="{pos:'bottom'}" Title="Delete" onclick="return ConfirmDialog()"><i class="material-icons" style="font-size:28px;color:#1976D2;"></i></a> &nbsp;
...
<div class="md-fab-wrapper">
    <a class="md-fab md-fab-accent" href="http://www.risusventures.com/usermanagement/addPrincipal"  Title="Add New Principal">
