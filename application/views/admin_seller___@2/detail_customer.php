...
<div class="md-card">
<div class="md-card-content">
<div class="uk-float-right uk-margin-top uk-margin-small-right"><i class="material-icons" style="font-size:35px;color:rgb(25, 118, 210)"></i></div>
<span class="uk-text-muted uk-text-small" style="color:red">Name</span>
<h2 class="uk-margin-remove"><span class="countUpMe" style="font-size:17px;"><?php echo $detail_customer[0]['customer_company'];?></span></h2>
</div>
</div>
</div>
<div style="">
...
<h2 class="uk-margin-remove"><span class="countUpMe" style="font-size:17px;"><?php echo $detail_customer[0]['customer_email'];?></span></h2>
</div>
</div>
</div>
<div style="">
...
<h2 class="uk-margin-remove"><span class="countUpMe" style="font-size:17px;"><?php echo $detail_customer[0]['customer_phone'];?></span></h2>
</div>
</div>
</div>
...
<span style="font-size:35px;color:white"><h2 style="color:white;" class="uk-icon-inr">&nbsp;<?php if($detail_customer[0]['total_Sales_customers']){echo number_format($detail_customer[0]['total_Sales_customers'],2);} else { echo number_format(0,2);}?></h2><br><b style="font-size: 26px;">Total Sales</b></span>
</div>
...
<div class="md-card-content uk-flex uk-flex-center uk-flex-middle">
<span style="font-size:35px;color:white;"><h2 style="color:white;"><?php echo $detail_customer[0]['customer_count'];?></h2><b style="font-size: 26px;">Total Order</b></span>
</div>
<div class="md-card-overlay-content">
<div class="uk-clearfix md-card-overlay-header">
</div>
...
<div class="md-card-content uk-flex uk-flex-center uk-flex-middle">
<span style="font-size:35px;color:white"><h2 style="color:white;" class="uk-icon-inr">&nbsp;<?php if($amount_detail[0]['total_customer_paid']){ echo number_format($amount_detail[0]['total_customer_paid'],2);}else { echo number_format(0,2);}?></h2><br><b style="font-size: 26px;">Total paid (<?php echo $detail_customer[0]['customer_paid'];?>)</b></span>
</div>
<div class="md-card-overlay-content">
<div class="uk-clearfix md-card-overlay-header">
</div>
...
<div class="md-card-content uk-flex uk-flex-center uk-flex-middle">
<span style="font-size:35px;color:white;"><h2 style="color:white;"><?php echo $detail_customer[0]['customer_canceled'];?></h2><b style="font-size: 26px;">Canceled</b></span>
</div>
<div class="md-card-overlay-content">
<div class="uk-clearfix md-card-overlay-header">
</div>
...
</div><div class="uk-grid uk-grid-width-small-1-2 uk-grid-width-large-1-3 uk-grid-width-xlarge-1-4 uk-text-center uk-sortable sortable-handler" id="dashboard_sortable_cards" data-uk-sortable="" data-uk-grid-margin="">
<div>
<div class="md-card md-card-hover md-card-overlay" style="background-color:#1976D2">
<div class="md-card-content uk-flex uk-flex-center uk-flex-middle">
<span style="font-size:35px;color:white"><h2 style="color:white;" class="uk-icon-inr">&nbsp;<?php  if(($detail_customer[0]['total_Sales_customers']) >($amount_detail[0]['total_customer_paid'])){echo number_format($detail_customer[0]['total_Sales_customers']-$amount_detail[0]['total_customer_paid'],2);} else { echo number_format(0,2);}?></h2><br><b style="font-size: 26px;">Total Due (<?php echo  $detail_customer[0]['customer_due'];?> )</b></span>
</div>
<div class="md-card-overlay-content">
<div class="uk-clearfix md-card-overlay-header">
</div>
...
<div class="md-card-content uk-flex uk-flex-center uk-flex-middle">
<span style="font-size:35px;color:white;"><h2 style="color:white;" class="uk-icon-inr">&nbsp;<?php if($detail_customer[0]['total_Sales_customers'] < ($amount_detail[0]['total_customer_paid'])){ echo number_format($amount_detail[0]['total_customer_paid']-$detail_customer[0]['total_Sales_customers'],2);}else { echo number_format(0,2);}?></h2><br><b style="font-size: 26px;">Total Advance</b></span>
</div>
<div class="md-card-overlay-content">
<div class="uk-clearfix md-card-overlay-header">
</div>
...
<div class="md-card-content uk-flex uk-flex-center uk-flex-middle">
<span style="font-size:35px;color:white"><h2 style="color:white;" ><?php  echo $detail_customer[0]['customer_pending'];?></h2><b style="font-size: 26px;">Total Pending</b></span>
</div>
<div class="md-card-overlay-content">
<div class="uk-clearfix md-card-overlay-header">
</div>
	 ...
	 <div class="md-card-content">
                    <div class="uk-overflow-container uk-margin-bottom">
                        <table class="uk-table uk-table-align-vertical uk-table-nowrap tablesorter tablesorter-altair" id="ts_pager_filter">
                            ...
                            <tbody>
                       <?php $i=1; foreach ($detail_customer as $key) {?> 
                     <tr>
					 <td><?php echo $i++;?></td>
                     <td><?php echo $key['invoice_no'];?></td>
                     <td><?php echo $key['invoice_date'];?></td>
                     <td><?php echo $key['customer_company']; ?></td>
                     <td><p class="uk-icon-inr">&nbsp;<?php echo $key['Total_amount'].'.00';?></p></td>
                     <td><p class="uk-icon-inr">&nbsp;<?php $payment = $this->db->query("select sum(invoice_paid_amount) as customer_paid from payment where invoice_id='".$key['id']."'");
                               $data= $payment->result_array();
                               foreach($data as $customer_report){ if($customer_report['customer_paid']){echo $customer_report['customer_paid'].'.00';}else{ echo '<p class="uk-icon-inr">&nbsp;0.00</p>';}}
                      ?></p></td>
                     <td><?php  $balance = $key['Total_amount']-$customer_report['customer_paid']; if($balance){ echo '<p class="uk-icon-inr">&nbsp;'.$balance.'.00<p>';}else{ echo '<p class="uk-icon-inr">&nbsp;0.00</p>';}?></td>
                     <td><?php if($key['status']=='Paid'){ echo'<span class="uk-badge uk-badge-success" style="padding: 3px 29px;">Paid</span>';}
                     elseif($key['status']=='Due'){ echo '<span class="uk-badge uk-badge-success" style="padding: 3px 29px;background-color:#0D8ECF;">Due</span>';}
                     elseif($key['status']=='Pending'){ echo '<span class="uk-badge uk-badge-success" style="padding: 3px 29px;background-color:#FCD202;">Pending</span>';}
                     elseif($key['status']=='canceled'){ echo '<span class="uk-badge uk-badge-danger" style="padding: 3px 29px;background-color:red;">Canceled</span>'; }
                     ?></td>
                     <td><i class="material-icons">&#xE7FD;</i>&nbsp;<?php echo $key['sales_person'];?></td>
                     <td><a href="<?php echo base_url();?>seller/print_invoice/<?php echo $key['id'];?>"><i class="material-icons" style="font-size:28px;color:#1976D2;"></i></a> <a href="<?php echo base_url();?>seller/delete_invoice/<?php echo $key['id'];?>" onclick="return ConfirmDialog()"><i class="material-icons" style="font-size:28px;color:#1976D2;" ></i></a></td>
                            </tr>
                            <?php }$i++;?>
                            </tbody>
                        </table>
...
if($aa < $bb)
{$advance_amount =$bb-$aa;}else{ $advance_amount =0;}
