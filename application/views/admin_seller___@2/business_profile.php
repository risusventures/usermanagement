        ...
        <div id="page_content_inner">
            ...
            <div class="md-card">
             ...
             { echo '<div class="uk-alert uk-alert-success" data-uk-alert="">
                    ...
                    <form id="form_validation"   name="contactform" id="contactform" onsubmit="return validateentry();"  class="uk-form-stacked" action="<?php echo base_url()?>profile/create_bussiness" enctype="multipart/form-data" Method="post">
