            ...
            <div class="md-card-content">
                ...
                <div class="uk-grid" data-uk-grid-margin="">
                     <div class="uk-width-medium-1-1 uk-row-first">
                        <?php echo form_open(base_url('seller/change_password'),array('id'=>'password_form','name'=>'contactname','class'=>'uk-form-stacked','onsubmit'=>'return validateentry();','enctype'=>'multipart/form-data' ));?>
