                ...
                <div class="md-card-content">
                    <div class="uk-grid" data-uk-grid-margin="">
                        <div class="uk-width-medium-5-10">
                            <div class="md-input-wrapper"><h2>Sales Person Report</h2><?php if(isset($_GET['submit'])){  echo '<strong>Date : '.$start_date.'&nbsp;To&nbsp;'.$end_date.'</strong>';}?></div><?php foreach($start_date as $start){ echo $start;}?>
                        </div>
                ...
                <div style="">
                    <div class="md-card">
                        <div class="md-card-content">
                            ...
                            <h2 class="uk-margin-remove"><span class="uk-icon-inr" style="font-size: 20px;">&nbsp;</span></h2>
                        </div>
                    </div>
                </div>
                <div style="">
                ...
                <div style="">
                    <div class="md-card">
                        <div class="md-card-content">
                            ...
                            <h2 class="uk-margin-remove" id="peity_live_text"><span class="uk-icon-inr" style="font-size: 20px;">&nbsp;</span></h2>
                        </div>
                    </div>
                </div>
                    <div style="">
