...
<a href="<?php echo base_url();?>exportOrder" class="btn btn-warning btn-sm dropdown-toggle"   style="background-color:#1976D2;border:none;padding: 8px;"><i class="material-icons" style="color:white;">view_list</i> Export Table Data</a>
                     ...
                     <table class="uk-table uk-table-align-vertical uk-table-nowrap tablesorter tablesorter-altair" id="ts_pager_filter">
                          ...
                          <?php $i=1; foreach ($order as $order) {?>
                            <tr><td></td>
                              ...
                              <td><p class="uk-icon-gbp">&nbsp;<?php echo $order['Total_amount'].'.00';?></p></td>
                                ...
                                <td><p class="uk-icon-gbp">&nbsp;<?php $balance = $order['Total_amount']-$paid_balance['paid_balance']; if($balance){echo $balance.'.00';}else {echo '0.00';} ?></p></td>
                                <td>  <?php
                         $pp_id =  $order['id'];
                    ...
                    <!---Add Payment--->
                      ...
                      <a href="#"  data-uk-modal="{target:'#modal_header_footer_<?php echo $order['invoice_no'];?>'}" data-uk-tooltip="{pos:'bottom'}" Title="Add Payment"><i class="material-icons" style="font-size:28px;color:#1976D2;">&#xE146;</i></a>
                            ...
                            <?php echo form_open(base_url('seller/add_payment'))?>
                           ...
                           <input type="hidden" name="invoice_number" value="<?php echo $order['invoice_no'];?>">
							...
							<input type="hidden" value="<?php echo $order['Total_amount'];?>" name="total_amount">
...
<?php echo form_close();?>
                    ...
                    <!---Add Payment--->
                         ...
                         <!--print---->
                       <a href="<?php echo base_url()?>printOrder/<?php echo $order['id'];?>" target="_blank" data-uk-tooltip="{pos:'bottom'}" title=" <?php if($order[status]!='Quotation'){ echo 'Invoice With Payment';}else{echo 'Quotation With Payment';}?>"><i class="material-icons" style="font-size:28px;color:#1976D2;">&#xE53E;</i></a>   
                       <a href="<?php echo base_url()?>printOrder/<?php echo $order['id'];?>?without=payment" target="_blank" data-uk-tooltip="{pos:'bottom'}" title="<?php if($order[status]!='Quotation'){ echo 'Invoice Without Payment';}else{echo 'Quotation Without Payment';}?>"><i class="material-icons" style="font-size:28px;color:#1976D2;">&#xE8AD;</i></a>       
                        <a href="<?php echo base_url()?>seller/edit_order/<?php echo $order['id'];?>" target="_blank" data-uk-tooltip="{pos:'bottom'}" title="Edit"><i class="material-icons" style="font-size:28px;color:#1976D2;">&#xE254;</i></a>
                        <!---Print-->       
                        <?php   if($order[status]!='Paid'){?>  <a href="<?php echo base_url()?>seller/delete_invoice/<?php echo $order['invoice_no'];?>"  data-uk-tooltip="{pos:'bottom'}" title="Delete"><i class="material-icons" style="font-size:28px;color:#1976D2;" onclick="return ConfirmDialog()">&#xE872;</i></a>   
                        <?php }?>
                        </td>
...
<a class="md-fab md-fab-accent" href="<?php echo site_url('addOrder');?>" id="recordAdd" title="Create New Order"  data-uk-tooltip="{pos:'bottom'}">
