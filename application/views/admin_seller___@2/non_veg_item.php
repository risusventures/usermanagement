...
<h4 class="heading_a uk-margin-bottom">View All Non-veg Items</h4>
            <div class="md-card">
    ...
    <a href="#" class="uk-alert-close uk-close"></a>Item successfully deleted.........</div>';}?>
				...
				<div class="md-card-content">
				   ...
				   <div class="uk-overflow-container uk-margin-bottom">
                     ...
                     <tr>
					 <td><?php echo $i++;?></td>
                     <td><?php echo $item['non_veg_name']; ?></td>
                     <td><?php echo $item['non_veg_ammount']; ?></td>
                     <td>
 <a href="#" data-uk-tooltip="{pos:'bottom'}" Title="edit" data-uk-modal="{target:'#modal_header_footer_<?php echo $item['non_veg_id']; ?>'}"><i class="material-icons" style="font-size:28px;color:#1976D2;"></i></a>
<div class="uk-modal" id="modal_header_footer_<?php echo $item['non_veg_id']; ?>" aria-hidden="true" style="display: none; overflow-y: auto;"> 
	<?php echo form_open(base_url('seller/update_non_veg_item'),array('id'=>'contactname','name'=>'contactname','class'=>'uk-form-stacked','enctype'=>'multipart/form-data' ));?>	                 
<input type="hidden" name="uid" class="md-input label-fixed" value="<?php echo $item['non_veg_id'];?>" data-parsley-id="4">				  
				  <div class="uk-modal-dialog" style="top: 88px;">
                            <div class="uk-modal-header"><h3 class="uk-modal-title">Update Item</h3></div>
 ...
 <div class="md-input-wrapper md-input-filled"><label>Item Name<span class="req">*</span></label><input type="text" name="item_name" class="md-input label-fixed" value="<?php echo $item['non_veg_name'];?>" data-parsley-id="4"  required><span class="md-input-bar"></span></div> 
 </div></div>
 
  <div class="uk-width-medium-1-2">
 <div class="parsley-row">
 <div class="md-input-wrapper md-input-filled"><label>Item Ammount<span class="req">*</span></label><input type="text" name="item_ammount" class="md-input label-fixed" value="<?php echo $item['non_veg_ammount'];?>" data-parsley-id="4"  required><span class="md-input-bar"></span></div> 
 </div></div>
                ...
                <?php echo form_close();?>
                     ...
                     <a href="<?php echo base_url()?>seller/delete_non_veg_item/<?php echo $item['non_veg_id'];?>" onclick="return ConfirmDialog()" data-uk-tooltip="{pos:'bottom'}" Title="Delete" onclick="return ConfirmDialog()"><i class="material-icons" style="font-size:28px;color:#1976D2;"></i></a> &nbsp;
	...
	<?php echo form_open(base_url('seller/item_non_veg_submit'),array('id'=>'contactname','name'=>'contactname','class'=>'uk-form-stacked','enctype'=>'multipart/form-data' ,'onsubmit'=>'return validateentry();'));?>	  
				   <div class="uk-modal-dialog" style="top: 88px;">
                ...
                <div class="md-card-content large-padding">
                        ...
                        <div class="uk-grid " data-uk-grid-margin="">
                            <div class="uk-width-medium-1-2">
                                <div class="parsley-row">
                                    <div class="md-input-wrapper"><label for="fullname">Item Name<span class="req">*</span></label><input type="text" name="item_name" class="md-input" value="" data-parsley-id="4"  required><span class="md-input-bar"></span></div> 
                                </div>
                            </div>
                                 <div class="uk-width-medium-1-2">
                                <div class="parsley-row">
                                    <div class="md-input-wrapper"><label for="fullname">Item Ammount<span class="req">*</span></label><input type="text" name="item_ammount" class="md-input" value="" data-parsley-id="4"  required><span class="md-input-bar"></span></div> 
                                </div>
                            </div>
                        </div>
...
<div class="md-fab-wrapper">
    <a class="md-fab md-fab-accent" href="#" id="recordAdd" data-uk-modal="{target:'#modal_header_footer_customers'}" data-uk-tooltip="{pos:'bottom'}" Title="Add New Item">
