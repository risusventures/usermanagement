...
<div class="md-card">
                <div class="md-card-content">
                    <div class="uk-grid" data-uk-grid-margin="">
                        ...
                        <div class="uk-width-medium-5-10">
                         <div class="md-input-wrapper"> <input class="raw" id="e1" name="chart_filter" style="height:50px;font-size:15px;"><a href="#" class="md-btn md-btn-primary uk-margin-small-top" style="margin-left:30px;">Filter</a></div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div style="">
                    <div class="md-card">
                        <div class="md-card-content">
                            ...
                            <h2 class="uk-margin-remove"><span class="uk-icon-inr" style="font-size: 20px;">12,456</span></h2>
                        </div>
                    </div>
                </div>
                <div style="">
                    <div class="md-card">
                        <div class="md-card-content">
                            ...
                            <h2 class="uk-margin-remove"><span class="uk-icon-inr" style="font-size: 20px;">142,384</span></h2>
                        </div>
                    </div>
                </div>
                <div style="">
                    <div class="md-card">
                        <div class="md-card-content">
                            ...
                            <h2 class="uk-margin-remove"><span class="uk-icon-inr" style="font-size: 20px;">6,400</span></h2>
                        </div>
                    </div>
                </div>
                <div style="">
                    <div class="md-card">
                        <div class="md-card-content">
                            ...
                            <h2 class="uk-margin-remove" id="peity_live_text"><span class="uk-icon-inr" style="font-size: 20px;">8,3235</span></h2>
                        </div>
                    </div>
                </div>
                    <div style="">
                    <div class="md-card">
                        <div class="md-card-content">
                            ...
                            <h2 class="uk-margin-remove" id="peity_live_text"><span class="uk-icon-inr" style="font-size: 20px;">8,3659</span></h2>
                        </div>
                    </div>
                </div>
                    <div style="">
                    <div class="md-card">
                        <div class="md-card-content">
                            ...
                            <h2 class="uk-margin-remove" id="peity_live_text"><span class="uk-icon-inr" style="font-size: 20px;">83</span></h2>
                        </div>
                    </div>
                </div>
            </div>
