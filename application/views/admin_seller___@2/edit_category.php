   ...
   <?php include('header_top.php');?>
    <div id="page_content" style="margin-left:0px;">
        <div id="page_content_inner">
            <h3 class="heading_b uk-margin-bottom">Edit Category</h3>
            <div class="md-card">
             ...
             { echo '<div class="uk-alert uk-alert-success" data-uk-alert="">
                    <a href="#" class="uk-alert-close uk-close"></a>Create Business Profile Successfully......</div>';}?>
                      <?php foreach ($records as $row ) {?>
						<?php echo form_open(base_url('seller/update_category'),array('id'=>'contactname','name'=>'contactname','class'=>'uk-form-stacked','onsubmit'=>'return validateentry();','enctype'=>'multipart/form-data' ));?>
                        <input type="text" name="uid" value="<?php echo $row['ci_id'];?>" hidden>
                     ...
                     <div class="user_heading" data-uk-sticky="{ top: 48, media: 960 }" style="padding-right:10px;">
                                <div class="user_heading_avatar fileinput fileinput-new" data-provides="fileinput">
                                    ...
                                    <input type="file" name="image" id="user_edit_avatar_control" onchange="check_upload(this)" value="">
                                </span>
                        ...
                        <div class="uk-grid " data-uk-grid-margin>
                            <div class="uk-width-medium-1-12">
                                <div class="parsley-row">
                                    ...
                                    <input type="text" name="category_name"  class="md-input" value="<?php echo $row['product_category'];?>"/>
                                </div>
                            </div>
                        </div>
                        <?php }?>
                       <div class="uk-grid" data-uk-grid-margin><br></br>
                   </div>
                        <div class="uk-grid">
