        ...
        <div class="md-card">
            <div class="md-card-content1">
                <div class="md-card-content ">
                    ...
                    <?php echo form_open(site_url('seller/update_contact'), array('id' => 'contactname', 'name' => 'contactname', 'class' => 'uk-form-stacked', 'onsubmit' => 'return validateentry();', 'enctype' => 'multipart/form-data')); ?>
                 ...
                 <input type="file" name="image" id="user_edit_avatar_control" onchange="check_upload(this)" value="<?php echo $key['image']; ?>">
                            ...
                            <div class="uk-width-medium-1-3">
                                <div class="parsley-row">
                                    ...
                                    <select id="val_select" required data-md-selectize name="roleid">
                                        ...
                                        <option value="1"<?php $role = $key['roleid'];
                                        if ($role == 1) { ?>  selected="selected" <?php } ?>>Admin User
                                        </option>
                                        <option value="2"<?php if ($role == 2) { ?>  selected=" selected" <?php } ?>>Sub
                                            User
                                        </option>
                        ...
                        <div class="uk-grid " data-uk-grid-margin>
                            <div class="uk-width-medium-1-3">
                                <div class="parsley-row">
                                    ...
                                    <input type="text" name="contact_name" class="md-input"
                                           value="<?php if(!empty($data)){echo $data['contact_name'];} ?>" style="margin-top: 10px;"/>
                                </div>
                            </div>
                            <div class="uk-width-medium-1-3">
                                <div class="parsley-row">
                                    <label for="fullname" style="top:4px;">CEO Name<span class="req">*</span></label>
                                    <input type="text" name="ceo_name" class="md-input"
                                           value="<?php if(!empty($data)){ echo $data['ceo_name'];} ?>" style="margin-top: 10px;"/>
                                </div>
                            </div>
                            <div class="uk-width-medium-1-3">
                                <div class="parsley-row">
                                    ...
                                    <input type="text" name="email" class="md-input"
                                           value="<?php if(!empty($data)){ echo $key['user_email'];} ?>" style="margin-top: 10px;"
                                           disabled=""/>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="uk-grid" data-uk-grid-margin>
                            <div class="uk-width-medium-1-3">
                                <div class="parsley-row">
                                    <label for="fullname" style="top:4px;">Bussiness Name<span
                                                class="req">*</span></label>
                                    <input type="text" name="company_name" class="md-input"
                                           value="<?php if(!empty($data)){ echo $data['company_name']; }?>" style="margin-top: 10px;"/>
                                </div>
                            </div>

                            <div class="uk-width-medium-1-3">
                                <div class="parsley-row">
                                    <label for="fullname" style="top:4px;">Bussines Address<span
                                                class="req">*</span></label>
                                    <input type="text" name="address" class="md-input"
                                           value="<?php if(!empty($data)){ echo $data['address'];} ?>" style="margin-top: 10px;"/>
                                </div>
                            </div>
                            ...
                            <div class="uk-width-medium-1-3">
                                <div class="parsley-row">
                                    ...
                                    <input type="text" name="city" class="md-input" value="<?php if(!empty($data)){ echo $data['city'];} ?>"
                            ...
                            <div class="uk-width-medium-1-3">
                                <div class="parsley-row">
                                    ...
                                    <input type="text" name="state" class="md-input"
                                           value="<?php if(!empty($data)){ echo $data['state'];}  ?>" style="margin-top: 10px;"/>
                                    </span>
                                </div>
                            </div>
                            <div class="uk-width-medium-1-3">
                                <div class="parsley-row">
                                    ...
                                    <input type="text" name="postal_code" class="md-input"
                                           value="<?php if(!empty($data)){ echo $data['postal_code'];} ?>" style="margin-top: 10px;"/>
                                    <span class="md-input-bar"></span>
                                </div>
                            </div>
                            <div class="uk-width-medium-1-3">
                                <div class="parsley-row">
                                    <label for="fullname" style="top:4px;">Mobile Number<span
                                                class="req">*</span></label>
                                    <input type="number" name="mobile_number" class="md-input"
                                           value="<?php if(!empty($data)){ echo $key['user_number'];} ?>" style="margin-top: 10px;"/>
                                    <span class="md-input-bar"></span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="uk-grid" data-uk-grid-margin="">
                            <div class="uk-width-medium-1-2">
                                <div class="parsley-row">
                                    ...
                                    <input type="number" name="fax_number" class="md-input"
                                           value="<?php if(!empty($data)){ echo $data['fax_number'];} ?>" style="margin-top: 10px;"/>
                                    </span>
                                </div>
                            </div>
                            <div class="uk-width-medium-1-2">
                                <div class="parsley-row">
                                    ...
                                    <input type="text" name="website" class="md-input"
                                           value="<?php if(!empty($data)){ echo $data['website']; } ?>" style="margin-top: 10px;"/>
                        ...
                        <div class="uk-grid " data-uk-grid-margin>
                            <div class="uk-width-medium-1-6">
                                <div class="parsley-row">
                                    ...
                                    <input type="checkbox" name="menu[]"
                                           value="dashboard" <?php $array = explode(',', $key['menu']);
                                    if (in_array("dashboard", $array)) { ?> checked="checked" <?php } ?> >Dashboard
                                </div>
                            </div>
                            <div class="uk-width-medium-1-6">
                                <div class="parsley-row">
                                    <h4>Principal</h4><br>
                                    <input type="checkbox" id="myCheck" name="menu[]"
                                           value="add_Pri" <?php $array = explode(',', $key['menu']);
                                    if (in_array("add_Pri", $array)) { ?> checked="checked" <?php } ?>>Add Principal<br>
                                    <input type="checkbox" id="myCheck" name="menu[]"
                                           value="manage_Pri" <?php $array = explode(',', $key['menu']);
                                    if (in_array("manage_Pri", $array)) { ?> checked="checked" <?php } ?>>Manage
                                    Principal
                                </div>
                            </div>
                            <div class="uk-width-medium-1-6">
                                <div class="parsley-row">
                                    <h4>Customers</h4><br>
                                    <input type="checkbox" id="myCheck" name="menu[]"
                                           value="add_cust" <?php $array = explode(',', $key['menu']);
                                    if (in_array("add_cust", $array)) { ?> checked="checked" <?php } ?>>Add Customer<br>
                                    <input type="checkbox" id="myCheck" name="menu[]"
                                           value="manage_customers" <?php $array = explode(',', $key['menu']);
                                    if (in_array("manage_customers", $array)) { ?> checked="checked" <?php } ?> >Manage
                                    Customers
                                </div>
                            </div>
                            <div class="uk-width-medium-1-6">
                                <div class="parsley-row">
                                    <h4>Order</h4><br>
                                    <input type="checkbox" id="myCheck1" name="menu[]"
                                           value="add_order" <?php $array = explode(',', $key['menu']);
                                    if (in_array("add_order", $array)) { ?> checked="checked" <?php } ?>>Add Order<br>
                                    <input type="checkbox" id="myCheck1" name="menu[]"
                                           value="manage_orders" <?php $array = explode(',', $key['menu']);
                                    if (in_array("manage_orders", $array)) { ?> checked="checked" <?php } ?>>Manage
                                    Orders<br>
                            ...
                            <div class="uk-width-medium-1-6">
                                <div class="parsley-row">
                                    <h4>Reports</h4><br>
                                    <input type="checkbox" id="myCheck1" name="menu[]"
                                           value="orders_report" <?php $array = explode(',', $key['menu']);
                                    if (in_array("orders_report", $array)) { ?> checked="checked" <?php } ?>>Orders
                                    Report<br>
                                    <input type="checkbox" id="myCheck1" name="menu[]"
                                           value="sales_report" <?php $array = explode(',', $key['menu']);
                                    if (in_array("sales_report", $array)) { ?> checked="checked" <?php } ?>>Sales Report
                            ...
                            <div class="uk-width-medium-1-6">
                                <div class="parsley-row">
                                    <h4>Sub Users</h4><br>
                                    <input type="checkbox" id="myCheck2" name="menu[]"
                                           value="add_sub" <?php $array = explode(',', $key['menu']);
                                    if (in_array("add_sub", $array)) { ?> checked="checked" <?php } ?> >Add Sub user<br>
                                    <input type="checkbox" id="myCheck2" name="menu[]"
                                           value="list_user" <?php $array = explode(',', $key['menu']);
                                    if (in_array("list_user", $array)) { ?> checked="checked" <?php } ?> >List Sub user
                                </div>
                            </div>
                            <div class="uk-width-medium-1-6">
                                <div class="parsley-row">
                                    <h4>Business Emails</h4><br>
                                    <input type="checkbox" id="myCheck2" name="menu[]"
                                           value="add_emails" <?php $array = explode(',', $key['menu']);
                                    if (in_array("add_emails", $array)) { ?> checked="checked" <?php } ?> >Add Sub
                                    user<br>
                                    <input type="checkbox" id="myCheck2" name="menu[]"
                                           value="list_order_emails" <?php $array = explode(',', $key['menu']);
                                    if (in_array("list_order_emails", $array)) { ?> checked="checked" <?php } ?> >List
                                    Sub user
                                </div>
                            </div>
                        </div>
