    ...
    <div class="md-card" id="login_card">
        <div class="md-card-content large-padding" id="login_form">
			...
			<?php
				if(!isset($temp_pass)){
			?>
            <?php echo form_open(site_url() . '/recover_password', array('id' => 'recover_password', 'method' => 'post', 'role' => 'form')) // echo form_open(base_url('user_ctrl/recover_password'),array('id'=>'login','method'=>'post','role'=>'form'))?>
            <div class="uk-form-row">
                <label for="login_username">Email</label>
                <input class="md-input" type="text" id="login_username" name="email_reset"/>
            </div>
			<div class="uk-form-row">
                <label for="login_username">Auth Code</label>
                <input class="md-input" type="text" id="auth_code" name="auth_code"/>
            </div>
			<div class="uk-form-row">
                <label for="login_username">Password</label>
                <input class="md-input" type="text" id="password" name="password"/>
            </div>
			<div class="uk-form-row">
                <label for="login_username">Conf Password</label>
                <input class="md-input" type="text" id="conf_pass" name="conf_pass"/>
            </div>
            <div class="uk-margin-medium-top">
                <a href="javascript:;"> <input type="submit" name="submit" value="Reset Password"
            ...
            <div class="uk-form-row">
				...
				$id = strrchr($url,"/");
				$token = substr($id,1,strlen($id));
				?>
                <input class="md-input" type="hidden" name="passtoken" value="<?php if($token){echo $token;} ?>"/>
            </div>
            <div class="uk-margin-medium-top">
        ...
        <div class="md-card-content large-padding uk-position-relative" id="login_help">
            ...
            <h2 class="heading_b uk-text-success">Back to Login</h2>
            <a href="<?php echo base_url('user_ctrl/index') ?>" id="login_show">Click Here</a>.
        </div>
    </div>
