    ...
    <div id="page_content_inner">
        ...
        <div class="md-card">
            <div class="md-card-content large-padding">
				...
				?>
                <?php echo form_open(site_url('Principal/update_Principal'), array('id' => 'saveprincipal', 'name' => 'saveprincipal', 'onsubmit' => 'return validateentry();', 'class' => 'uk-form-stacked', 'enctype' => 'multipart/form-data')); ?>
                <input type="hidden" name="uid" class="md-input label-fixed"
                       value="<?php echo $edit_principal['pri']['Principal_id']; ?>" data-parsley-id="4">
                <div class="uk-grid " data-uk-grid-margin>

                    <div class="uk-width-1-3">
                        <div class="parsley-row">
                            <label for="fullname">Name<span class="req">*</span></label>
                            <input type="text" required="required" name="Principal_person" class="md-input"
                                   value="<?php echo $edit_principal['pri']['Principal_person'] ?>"/>
                        </div>
                    </div>
                    <div class="uk-width-medium-1-3">
                        <div class="parsley-row">
                            <label for="short">Short Name<span class="req">*</span></label>
                            <input type="text" name="short_name" class="md-input"
                                   value="<?php echo $edit_principal['pri']['short_name'] ?>"/>
                        </div>
                    </div>
                    <div class="uk-width-medium-1-3" style="display:none;">
                        <div class="parsley-row">
                            <label for="email">Email Address<span class="req">*</span></label>
                            <input type="text" name="Principal_email" class="md-input"
                                   value="<?php echo $edit_principal['pri']['Principal_email'] ?>"/>
                        </div>
                    </div>
                    <div class="uk-width-1-3">
                        <div class="parsley-row">
                            <label for="fullname">Phone<span class="req">*</span></label>
                            <input type="number" required="required" name="Principal_phone" class="md-input"
                                   value="<?php echo $edit_principal['pri']['Principal_phone'] ?>"/>
                        </div>
                    </div>
                </div>
                ...
                <div class="uk-grid " data-uk-grid-margin>
                    ...
                    <div class="uk-width-medium-1-3">
                        <div class="parsley-row">
                            ...
                            <input type="text" required="required" name="Principal_address" class="md-input"
                                   value="<?php echo $edit_principal['pri']['Principal_address'] ?>"/>
                        </div>
                    </div>
                    <div class="uk-width-medium-1-3">
                        <div class="parsley-row">
                            <label for="email">City<span class="req">*</span></label>
                            <input type="text" required="required" name="Principal_city" class="md-input"
                                   value="<?php echo $edit_principal['pri']['Principal_city'] ?>"/>
                        </div>
                    </div>
                    <div class="uk-width-medium-1-3">
                        <div class="parsley-row">
                            <label for="fullname">Country<span class="req">*</span></label>
                            <input type="text" required="required" name="Principal_country" class="md-input"
                                   value="<?php echo $edit_principal['pri']['Principal_country'] ?>"/>
                        </div>
                    </div>
                </div>
                <div class="uk-grid " data-uk-grid-margin>
                    ...
                    <div class="uk-width-medium-1-3">
                        <div class="parsley-row">
                            ...
                            <input type="text" name="Principal_postal_code" class="md-input"
                                   value="<?php echo $edit_principal['pri']['Principal_postal_code'] ?>"/>
                        </div>
                    </div>
                </div>
                ...
                <div id="reapeat" style="margin-top: 20px">
                    ...
                    <?php if (!empty($edit_principal['principal_products'])) {
                        ...
                        foreach ($edit_principal['principal_products'] as $k => $vvv) { ?>
                            <div id="principal_products_<?php echo $vvv['id']; ?>" class="uk-grid " data-uk-grid-margin>
                                <div class="uk-width-1-3">
                                    ...
                                    <input type="hidden" name="products[id][]" class="md-input"
                                           value="<?php echo $vvv['id'] ?>"/>
                                    <input type="text" name="products[name][]" class="md-input"
                                           value="<?php echo $vvv['product_name'] ?>"/>
                                </div>

                                <div class="uk-width-1-3" style="display:none">
                                    <label for="email">Product Price<span class="req">*</span></label>
                                    <input type="text" name="products[price][]" class="md-input"
                                           style="padding-top: 25px;" value="<?php echo $vvv['product_price'] ?>"/>
                                </div>

                                <a href="javascript:void(0)"
                                   onclick="principal_products('<?php echo $vvv['id']; ?>')"><i class="material-icons"
                                                                                                title="Delete"
                                                                                                style="font-size:28px;color:#1976D2;">close</i></a>
                            </div>
                        ...
                        <div class="uk-grid " data-uk-grid-margin>
                            ...
                            <div class="uk-width-1-3" style="display:none">
                                <label for="email">Product Price<span class="req">*</span></label>
                                <input type="text" name="products[price][]" style="padding-top: 25px;" class="md-input"
                                       value="0"/>
                            </div>
                        </div>
                    <?php } ?>
                ...
                <div class="uk-grid" style="margin-top: 20px">
                    <div class="uk-width-1-1">
                        <button type="button" class="md-btn md-btn-success" onclick="add_product()" name="add">Add
                            Product
                        </button>
                    </div>
    ...
    <script type="text/javascript">
        ...
        function principal_contacts(id) {
            $.ajax({
                ...
                url: '<?php echo site_url('Principal/del_contacts?id=')?>' + id,
        ...
        function principal_products(id) {
            ...
            $.ajax({
                ...
                url: '<?php echo site_url('Principal/del_products?id=')?>' + id,
