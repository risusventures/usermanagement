    ...
    <div id="page_content_inner">
        ...
        <div class="md-card">
            <div class="md-card-content large-padding">
                ...
                <?php echo form_open(site_url('seller/savebusiness'), array('id' => 'contactform', 'name' => 'contactform', 'onsubmit' => 'return validateentry();', 'class' => 'uk-form-stacked', 'enctype' => 'multipart/form-data')); ?>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="col-md-12">
                            <div class="parsley-row">
                                ...
                                <?php 
								$list_principle_model = $this->product_model->list_principle_model($data['user_id']);
                                ...
                                <select onchange="get_subpriciple();ggg();" name="pid" id="pid" class="md-input">
                                    ...
                                    <?php if (!empty($list_principle_model)) {
                                        foreach ($list_principle_model as $edd) { ?>
                                            <option value="<?php echo $edd['Principal_id'] . "::" . $edd['short_name'] ?>"><?php echo $edd['Principal_person'] ?></option>
                                        <?php }
                                    } ?>
                                </select>
                                ...
                                <select onchange="get_subcustomer();ggg();" name="cid" id="cid" class="md-input">
                                    ...
                                    <?php if (!empty($customer)) {
                                        foreach ($customer as $edd) { ?>
                                            <option value="<?php echo $edd['customer_id'] . "::" . $edd['short_name'] ?>"><?php echo $edd['customer_person'] ?></option>
                                        <?php }
                                    } ?>
                                </select>
                            </div>
                        ...
                        <div class="col-md-12">
                            <div class="parsley-row hide pidcid">
                                ...
                                <input type="text" id="messageid" readonly="readonly" name="messageid"
                                       class="md-input ddd"/>
                            </div>
                        </div>
                            ...
                            <div class="us">
                                <div class="parsley-row">
                                    <div class="md-input-wrapper "><label for="message">Enter Messages</label><textarea
                                                ...
                                                rows="10" style="height:auto;"></textarea><span
