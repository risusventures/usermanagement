...
<div id="page_content" style="margin-left:0px;">
    ...
    <a href="#" class="uk-alert-close uk-close"></a>Company Profile Updated  Successfully......</div>';
            ...
            <div>
                <div class="md-card">
                    <div class="md-card-content">
                        <div class="uk-float-right uk-margin-top uk-margin-small-right"><i class="material-icons"
                                                                                           style="font-size:27px;">shopping_cart</i>
                        </div>
                        <span class="uk-text-muted uk-text-small">Total Order</span>
                        <h2 class="uk-margin-remove"><span
                                    class="countUpMe"><?php echo $invoice[0]['invoice']; ?></span></h2>
                    </div>
                </div>
            </div>
            <div>
                <div class="md-card">
                    <div class="md-card-content">
                        <div class="uk-float-right uk-margin-top uk-margin-small-right"><i class="uk-icon-thumbs-up"
                                                                                           style="font-size:27px;"></i>
                        </div>
                        <span class="uk-text-muted uk-text-small">Total Paid</span>
                        <h2 class="uk-margin-remove"><span
                                    class="countUpMe"><?php echo $invoice[0]['paid_count']; ?></span></h2>
                    </div>
                </div>
            </div>
            <div>
                <div class="md-card">
                    <div class="md-card-content">
                        <div class="uk-float-right uk-margin-top uk-margin-small-right"><i class="uk-icon-tachometer"
                                                                                           style="font-size:27px;"></i>
                        </div>
                        <span class="uk-text-muted uk-text-small">Total Due</span>
                        <h2 class="uk-margin-remove"><span
                                    class="countUpMe"><?php echo $invoice[0]['due_count']; ?></span></h2>
                    </div>
                </div>
            </div>
            <div>
                <div class="md-card">
                    <div class="md-card-content">
                        <div class="uk-float-right uk-margin-top uk-margin-small-right"><i
                                    class="uk-icon-justify uk-icon-github" style="font-size:27px;"></i></div>
                        <span class="uk-text-muted uk-text-small">Total Pending</span>
                        <h2 class="uk-margin-remove"><span
                                    class="countUpMe"><?php echo $invoice[0]['pending_count']; ?></span></h2>
                    </div>
                </div>
            </div>
            <div>
                <div class="md-card">
                    <div class="md-card-content">
                        <div class="uk-float-right uk-margin-top uk-margin-small-right"><i class="uk-close uk-close-alt"
                                                                                           style="opacity:0px;box-shadow:#727272"></i>
                        </div>
                        <span class="uk-text-muted uk-text-small">Total Canceled</span>
                        <h2 class="uk-margin-remove"><span
                                    class="countUpMe"><?php echo $invoice[0]['canceled_count']; ?><noscript></noscript></span>
                        </h2>
                    </div>
                </div>
            </div>
        ...
        <!-- info cards -->
        <div class="uk-grid uk-grid-medium uk-grid-width-medium-1-2 uk-grid-width-large-1-2" data-uk-grid-margin
                                            ...
                                            <div class="md-card-head md-bg-light-blue-600"
                                                ...
                                                <div class="md-card-head-menu" data-uk-dropdown="{pos:'bottom-right'}">
                                                    <a class="md-fab md-fab-small md-fab-accent"
                                                       href="<?php echo site_url() ?>profile/edit_contact/<?php echo $records4[0]['cp_id']; ?>">
                                                ...
                                                <div class="uk-text-center">
                                                    <img class="md-card-head-avatar"
                                                         src="<?php echo base_url() ?>assets/file_icon/profile_image/thum/<?php if ($records4[0]['image']) {
                                                             echo $records4[0]['image'];
                                                         } else {
                                                             echo 'dummy1.jpg';
                                                         }; ?>" alt=""
                                                         style="border-radius:0px;width:200px;height:100px;">
                                                </div>
...
<div class="uk-grid uk-grid-width-small-1-2 uk-grid-width-large-1-3 uk-grid-width-xlarge-1-2 uk-text-center uk-sortable sortable-handler"
     id="dashboard_sortable_cards" data-uk-sortable="" data-uk-grid-margin="">
                ...
                <div>
                   <div class="md-card md-card-hover " style="background-color:#f88529">
                       <a href="<?php echo site_url(); ?>/Sales" style="text-decoration:none;">
                    <div class="md-card-content uk-flex uk-flex-center uk-flex-middle">
                     <span style="font-size:35px;color:white"><b style="font-size:17px;"><i class="material-icons"
                                                                                            style="font-size:27px;color:white"></i><br>Sales</b></span>
                        </div></a>
                    </div>
                </div>
                <div>
                <div class="md-card md-card-hover" style="background-color: rgba(0, 128, 0, 0.68);">
                     <a href="<?php echo site_url(); ?>/addOrder" style="text-decoration:none;">
                        <div class="md-card-content uk-flex uk-flex-center uk-flex-middle">
                         <span style="font-size:35px;color:white;"><b style="font-size: 17px;"><i class="material-icons"
                                                                                                  style="font-size:27px;color:white">shopping_cart</i><br>Add Order</b></span>
                        </div></a>
                    </div>
                </div>
                <div>
                           ...
                           <div class="md-card md-card-hover" style="background-color:#1976D2;">
                              <a href="<?php echo site_url(); ?>/addCustomer" style="text-decoration:none;">
                        <div class="md-card-content uk-flex uk-flex-center uk-flex-middle">
                         <span style="font-size:35px;color:white;"><b style="font-size:17px;"><i class="material-icons"
                                                                                                 style="font-size:27px;color:white">group</i><br>Add Customer</b></span>
                        </div></a>
                    </div>
                </div>
                <div>
                 <div class="md-card md-card-hover" style="background-color:#52B9E9;">
                <a href="<?php echo site_url(); ?>/changePassword" style="text-decoration:none;">
                        <div class="md-card-content uk-flex uk-flex-center uk-flex-middle"
                             style="background-color: rebeccapurple">
                         <span style="font-size:35px;color:white"><b style="font-size:17px;"><i class="material-icons"
                                                                                                style="font-size:27px;color:white"></i><br> Change Password</b></span>
                        </div></a>
                     </div>
                    </div>
                          <div>
                   <div class="md-card md-card-hover " style="background-color:#333021">
                       <a href="<?php echo site_url(); ?>/manageCustomers" style="text-decoration:none;">
                    <div class="md-card-content uk-flex uk-flex-center uk-flex-middle">
                     <span style="font-size:35px;color:white"><b style="font-size:17px;">
                     <i class="material-icons"
                        style="font-size:27px;color:white">view_list</i><br>View Customers</b></span>
                        </div></a>
                    </div>
                </div>
                <div>
                <div class="md-card md-card-hover" style="background-color:#8B1267;">
                     <a href="<?php echo site_url(); ?>/manageOrder" style="text-decoration:none;">
                        <div class="md-card-content uk-flex uk-flex-center uk-flex-middle">
                         <span style="font-size:35px;color:white;"><b style="font-size: 17px;">
                      <i class="material-icons"
                         style="font-size:27px;color:white">view_list</i><br>View Orders</b></span>
                        </div></a>
                    </div>
                </div>
                  </div>
            ...
            <div class="uk-width-medium-1-1">
                <div class="md-card">
                    ...
                    <div class="md-card-content">
                        ...
                        <table class="uk-table">
                            <tr>
                                <div class="uk-text-center uk-margin-top uk-margin-small-bottom" style="width:100%;">
                                    <a href="<?php echo base_url(); ?>manageOrder"
                                       class="md-btn md-btn-flat md-btn-flat-primary js-uk-prevent"
                                       style="background-color:#1976D2;color:white;">Show All</a>
                                </div>
                            </tr>
                        </table>
                    </div>
    ...
    <?php foreach ($invoice as $invoice) { ?>
        <div class="uk-grid uk-grid-width-small-1-2 uk-grid-width-large-1-3 uk-grid-width-xlarge-1-6 uk-text-center uk-sortable sortable-handler"
             id="dashboard_sortable_cards" data-uk-sortable="" data-uk-grid-margin="">
                    ...
                    <a href="<?php echo base_url(); ?>manageOrder">
                        <div class="md-card-content uk-flex uk-flex-center uk-flex-middle">
                            <span style="font-size:35px;color:white"><h2
                                        style="color:white"><?php echo $invoice['invoice']; ?></h2><b
                                        style="font-size: 26px;">Orders</b></span>
                        </div>
            ...
            <div>
                <div class="md-card md-card-hover md-card-overlay" style="background-color: rgba(0, 128, 0, 0.68);"
                     style="padding-bottom:0px;postion:none;">
                    <a href="<?php echo base_url(); ?>manageOrder">
                        <div class="md-card-content uk-flex uk-flex-center uk-flex-middle">
                            <span style="font-size:35px;color:white;"><h2
                                        style="color:white">Rs.<?php if ($invoice['total']) {
                                        $total_amount = $invoice['total'];
                                        echo $total_amount;
                                    } else {
                                        echo '0';
                                    } ?>/-</h2><b style="font-size: 26px;">Total Amount</b></span>
                        </div>
                        <div class="md-card-overlay-content">
                            <div class="uk-clearfix md-card-overlay-header">
                            </div>
            ...
            <div>
                <div class="md-card md-card-hover md-card-overlay" style="background-color:#1976D2;">
                    <a href="<?php echo base_url(); ?>manageOrder">
                        <div class="md-card-content uk-flex uk-flex-center uk-flex-middle">
                            <span style="font-size:35px;color:white;"><h2
                                        style="color:white">Rs.<?php if ($data[0]['total_paid']) {
                                        echo $data[0]['total_paid'];
                                    } else {
                                        echo '0';
                                    } ?></h2><b style="font-size: 26px;">Paid</b></span>
                        </div>
                        <div class="md-card-overlay-content">
                            <div class="uk-clearfix md-card-overlay-header">
                            </div>
                ...
                <div class="md-card md-card-hover md-card-overlay" style="background-color:#008897;">
                    <a href="<?php echo base_url(); ?>manageOrder">
                        <div class="md-card-content uk-flex uk-flex-center uk-flex-middle">
                            <span style="font-size:35px;color:white;"><h2
                                        style="color:white">Rs.<?php if (invoice['total']) {
                                        $total_due = $invoice['total'] - $data[0]['total_paid'];
                                        echo $total_due;
                                    } else {
                                        echo '0';
                                    } ?></h2><b style="font-size: 26px;">Due</b></span>
                        </div>
                        <div class="md-card-overlay-content">
                            <div class="uk-clearfix md-card-overlay-header">
                            </div>
                ...
                <div class="md-card md-card-hover md-card-overlay" style="background-color:#52B9E9;">
                    <a href="<?php echo base_url(); ?>manageOrder">
                        <div class="md-card-content uk-flex uk-flex-center uk-flex-middle"
                             style="background-color: rebeccapurple">
                            <span style="font-size:35px;color:white"><h2
                                        style="color:white">Rs.<?php if ($invoice['pending']) {
                                        echo $invoice['pending'];
                                    } else {
                                        echo '0';
                                    } ?></h2><b style="font-size: 26px;">Pending</b></span>
                        </div>
                        <div class="md-card-overlay-content">
                            <div class="uk-clearfix md-card-overlay-header">
                            </div>
            ...
            <div>
                <div class="md-card md-card-hover md-card-overlay" style="background-color: red;">
                    <a href="<?php echo base_url(); ?>manageOrder">
                        <div class="md-card-content uk-flex uk-flex-center uk-flex-middle"
                             style="background-color: #fa3031;">
                            <span style="font-size:35px;color:white"><h2
                                        style="color:white"><?php if ($invoice['canceled']) {
                                        echo $invoice['canceled'];
                                    } else {
                                        echo '0';
                                    } ?></h2><b style="font-size: 26px;">Canceled</b></span>
                        </div>
                        <div class="md-card-overlay-content">
                            <div class="uk-clearfix md-card-overlay-header">
                            </div>
            ...
            <div>
                <div class="md-card md-card-hover md-card-overlay" style="background-color: red;">
                    <a href="<?php echo base_url(); ?>manageCustomers">
                        <div class="md-card-content uk-flex uk-flex-center uk-flex-middle"
                             style="background-color: #fa3031;">
                            <span style="color:white"><h2
                                        style="color:white"><?php if ($total_customers[0]['customers']) {
                                        echo $total_customers[0]['customers'];
                                    } else {
                                        echo '0';
                                    } ?></h2><b style="font-size: 26px;">Total Customers</b></span>
                        </div>
                        <div class="md-card-overlay-content">
                            <div class="uk-clearfix md-card-overlay-header">
                            </div>
