        ...
        <div class="md-card">
            <div class="md-card-content1">
                <div class="md-card-content ">
                    ...
                    <?php echo form_open(site_url('profile/update_contact'), array('id' => 'contactname', 'name' => 'contactname', 'class' => 'uk-form-stacked', 'onsubmit' => 'return validateentry();', 'enctype' => 'multipart/form-data')); ?>
                            ...
                            <div class="user_heading" data-uk-sticky="{ top: 48, media: 960 }"
                                ...
                                <div class="user_heading_avatar fileinput fileinput-new" data-provides="fileinput">
                                    <div class="fileinput-new thumbnail">
                                        <img src="<?php echo base_url(); ?>assets/file_icon/profile_image/<?php echo $key['image']; ?>"
                                             alt="user avatar"/>
                                    </div>
                 ...
                 <input type="file" name="image" id="user_edit_avatar_control" onchange="check_upload(this)"
                        value="<?php echo $key['image']; ?>">
                                        </span>
                            ...
                            <div class="uk-width-medium-1-3">
                                <div class="parsley-row">
                                    ...
                                    <input type="text" name="contact_name" class="md-input"
                                           value="<?php echo $key['contact_name']; ?>" style="margin-top: 10px;"/>
                                </div>
                            </div>
                            <div class="uk-width-medium-1-3">
                                <div class="parsley-row">
                                    ...
                                    <input type="text" name="ceo_name" class="md-input"
                                           value="<?php echo $key['ceo_name']; ?>" style="margin-top: 10px;"/>
                                </div>
                            </div>
                            <div class="uk-width-medium-1-3">
                                <div class="parsley-row">
                                    ...
                                    <input type="text" name="email" class="md-input"
                                           value="<?php echo $key['email']; ?>" style="margin-top: 10px;"/>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="uk-width-medium-1-3">
                                <div class="parsley-row">
                                    ...
                                    <input type="text" name="company_name" class="md-input"
                                           value="<?php echo $key['company_name']; ?>" style="margin-top: 10px;"/>
                                </div>
                            </div>
                            ...
                            <div class="uk-width-medium-1-3">
                                <div class="parsley-row">
                                    ...
                                    <input type="text" name="address" class="md-input"
                                           value="<?php echo $key['address']; ?>" style="margin-top: 10px;"/>
                                </div>
                            </div>
                            ...
                            <div class="uk-width-medium-1-3">
                                <div class="parsley-row">
                                    ...
                                    <input type="text" name="state" class="md-input"
                                           value="<?php echo $key['state']; ?>" style="margin-top: 10px;"/>
                                    </span>
                                </div>
                            </div>
                            <div class="uk-width-medium-1-3">
                                <div class="parsley-row">
                                    ...
                                    <input type="text" name="postal_code" class="md-input"
                                           value="<?php echo $key['postal_code']; ?>" style="margin-top: 10px;"/>
                            ...
                            <div class="uk-width-medium-1-3">
                                <div class="parsley-row">
                                    ...
                                    <input type="number" name="mobile_number" class="md-input"
                                           value="<?php echo $key['mobile_number']; ?>" style="margin-top: 10px;"/>
                                    <span class="md-input-bar"></span>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="uk-width-medium-1-2">
                                <div class="parsley-row">
                                    ...
                                    <input type="number" name="fax_number" class="md-input"
                                           value="<?php echo $key['fax_number']; ?>" style="margin-top: 10px;"/>
                                    </span>
                                </div>
                            </div>
                            <div class="uk-width-medium-1-2">
                                <div class="parsley-row">
                                    ...
                                    <input type="text" name="website" class="md-input"
                                           value="<?php echo $key['website']; ?>" style="margin-top: 10px;"/>
