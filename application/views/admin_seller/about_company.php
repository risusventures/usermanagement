...
<head>
    ...
    <script src="<?php echo base_url() ?>assets/js/pages/forms_file_upload.min.js"></script><?php include('analytics.php'); ?>
</head>
<body
    ...
    <div id="page_content_inner">
        ...
        <div class="md-card">
            <div class="md-card-content large-padding">
                ...
                <form novalidate="" id="form_validation" class="uk-form-stacked" method="post"
                      action="<?php echo site_url() ?>profile/create_about">
                    <div class="uk-grid" data-uk-grid-margin="">
                        <div class="uk-width-medium-1-1">
                            <div class="parsley-row">
                                <div class="md-input-wrapper"><label for="fullname">About Us Heading<span
                                                class="req">*</span></label><input name="about_company" class="md-input"
                                                                                   type="text"><span
                        ...
                        <div class="uk-width-1-1">
                            <div class="parsley-row">
                                <div class="md-input-wrapper "><label for="message">Description </label><textarea
                                            name="about_description" data-parsley-id="32"
                                            style="overflow-x: hidden; word-wrap: break-word; height: 217px;"
                                            class="md-input" cols="10" rows="8"></textarea><span
                                            class="md-input"></span></div>
