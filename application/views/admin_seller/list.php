    ...
    <div id="page_content_inner">
        ...
        <div class="md-card uk-margin-medium-bottom">
            <div class="md-card-content">
                ...
                if ($message) {
                    echo '<div class="uk-alert uk-alert-info" data-uk-alert=""><a href="#" class="uk-alert-close uk-close"></a>
                        ...
                        <table id="dt_tableTools" id="printablediv" class="uk-table" cellspacing="0" width="100%">
                            ...
                            <tr>
                                ...
                                <td>
                                    <!---view payment---->
                                    <a href="#"
                                       data-uk-modal="{target:'#modal_header_footer__<?php echo $order['invoice_no']; ?>'}">
                                        <i class="material-icons md-24">&#xE227;</i></a>
                                    <div class="uk-modal" id="modal_header_footer__<?php echo $order['invoice_no']; ?>"
                                         aria-hidden="true" style="display: none; overflow-y: scroll;">
                                        <div class="uk-modal-dialog" style="top: 66px;">
                                            <div class="uk-modal-header">
                                                <h3 class="uk-modal-title">View Payments (Order
                                                    No <?php echo $order['invoice_no']; ?>)</h3>
                                            </div>
                                            <p>
                                                ...
                                                <table class="uk-table uk-table-striped">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><i class="material-icons"
                                                               style="color:#1976D2;">&#xE8AD;</i> <i
                                                                    class="material-icons md-24" style="color:#1976D2;">&#xE254;</i>
                                                            <i class="material-icons md-24" style="color:#1976D2;">&#xE872;</i>
                                                        </td>
                                                    </tr>
                                                    </tbody>
                                                </table>
                                    ...
                                    <a href="#"
                                       data-uk-modal="{target:'#modal_header_footer_<?php echo $order['invoice_no']; ?>'}">
                                        <i class="material-icons md-24">&#xE147;</i></a>
                                    <div class="uk-modal" id="modal_header_footer_<?php echo $order['invoice_no']; ?>"
                                         aria-hidden="true" style="display: none; overflow-y: scroll;">
                                        <div class="uk-modal-dialog" style="top: 66px;">
                                            <div class="uk-modal-header">
                                                <h3 class="uk-modal-title">Add Payment</h3>
                                            </div>
                                            <form method="post" action="<?php echo site_url(); ?>/seller/add_payment">
                                                <div class="md-card">
                                                    <div class="md-card-content">
                                                                        ...
                                                                        <div class="uk-width-medium-1-2">
                                                                            <div class="md-input-wrapper">
                                                                                <label>Date</label><input type="text"
                                                                                                          ...
                                                                                                          id="invoice_date"
                                                                                                          name="invoice_date"
                                                                                                          value="<?php echo $order['invoice_date']; ?>"><span
                                                                                        class="md-input-bar"
                                                                                        value=""></span></div>

                                                                        </div>
                                                                        <div class="uk-width-medium-1-2">
                                                                            <div class="md-input-wrapper"><label>Amount
                                                                                    Paid</label><input type="text"
                                                                                                       class="md-input"
                                                                                                       id="invoice_amount"
                                                                                                       name="invoice_amount"><span
                                                    ...
                                                    <div class="uk-modal-footer uk-text-right">
                                                        <button type="button" class="md-btn md-btn-flat uk-modal-close"
                                                                style="color:black">Close
                                                        </button>
                                                        <button type="button" class="md-btn md-btn-
flat md-btn-flat-primary" style="background-color:#1976d2;color:white">Add
                ...
                <a href="#" data-uk-modal="{target:'#modal_header_footer___<?php echo $order['invoice_no']; ?>'}"><i
                            class="material-icons md-24">&#xE8A0;</i></a>
                <div class="uk-modal" id="modal_header_footer___<?php echo $order['invoice_no']; ?>" aria-hidden="true"
                     style="display: none; overflow-y: scroll;">
                    <div class="uk-modal-dialog" style="top: 66px;">
                        <div class="uk-modal-header">
                            <h3 class="uk-modal-title">He</h3>
                        </div>
                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Alias, aliquid amet animi
                            aspernatur aut blanditiis doloribus eligendi est fugiat iure iusto laborum modi mollitia
                            nemo pariatur, rem tempore. Dolor, excepturi.</p>
                        <div class="uk-modal-footer uk-text-right">
                ...
                <a href="#" data-uk-modal="{target:'#modal_header_footer____<?php echo $order['invoice_no']; ?>'}"> <i
                            class="material-icons md-24">&#xE2C0;</i></a>
                <div class="uk-modal" id="modal_header_footer____<?php echo $order['invoice_no']; ?>" aria-hidden="true"
                     style="display: none; overflow-y: scroll;">
                    <div class="uk-modal-dialog" style="top: 66px;">
                        <div class="uk-modal-header">
                ...
                <div class="uk-modal" id="modal_header_footer" aria-hidden="true"
                     style="display: none; overflow-y: scroll;">
                    <div class="uk-modal-dialog" style="top: 66px;">
                        <div class="uk-modal-header">
        ...
        <center>
            <ul>
                <div class="md-card-toolbar-actions">
                    ...
                    <i class="material-icons" style="font-size:35px;color:#39f;"
                       onclick="javascript:printDiv('printablediv')">&#xE8AD;</i>
                </div>
            </ul>
        </center>
        </form>
