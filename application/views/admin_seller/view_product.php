                            ...
                            <div class="uk-width-large-1-2">
                                <div class="uk-grid uk-grid-small">
                                    ...
                                    <div class="uk-width-large-2-3">
                                        <span class="uk-text-large uk-text-middle"><a href="#"
                                                                                      style="text-transform:capitalize;"><?php echo $row->product_name; ?></a></span>
                                    </div>
                                </div>
                                ...
                                <div class="uk-grid uk-grid-small">
                                    ...
                                    <div class="uk-width-large-2-3">
                                        <strong>Rs</strong>,<?php echo $row->price; ?><strong>
                                            / </strong><?php echo $row->per; ?>
                                    </div>
                                </div>
...
<div class="md-fab-wrapper">
    <a class="md-fab md-fab-primary" href="<?php echo site_url() ?>editProduct/<?php echo $row->id; ?>">
