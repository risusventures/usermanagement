...
<head>
    ...
    <!-- fullcalendar -->
    <link rel="stylesheet"
          href="<?php echo base_url(); ?>assets/bower_components/fullcalendar/dist/fullcalendar.min.css">
    <!-- altair admin -->
...
<div id="page_content" style="margin-left:0px;">
    ...
    <a href="#" class="uk-alert-close uk-close"></a>Company Profile Updated  Successfully......</div>';
        ...
        <div class="uk-grid uk-grid-width-large-1-3 uk-grid-width-medium-1-2 uk-grid-medium uk-sortable sortable-handler hierarchical_show"
                  ...
                  <div>
                    <div class="md-card">
                        <div class="md-card-content">
                            ...
                            <h2 class="uk-margin-remove"><?php if (($invoice['total']) < ($data[0]['total_paid'])) {
                $advance = $invoice['total'] - $data[0]['total_paid'];
                echo $advance;
            } else {
                echo '0';
            } ?></h2>
        ...
        <div class="uk-grid">
            ...
            <div class="uk-width-1-1">
                <div class="md-card">
                    <?php echo form_open(site_url('dashboard'), array('method' => 'GET')); ?>
                    <div class="md-card-toolbar">
                        <div class="md-card-toolbar-actions">
                            <div class="col-md-4"><p><input class="raw" id="e1" name="chart_filter"><input type="submit"
                                                                                                           value="Filter"
                                                                                                           style="height:30px;"/>
                                </p>
                            </div>
        ...
        <!--- <div class="uk-grid uk-grid-medium uk-grid-width-medium-1-2 uk-grid-width-large-1-3" data-uk-grid-margin data-uk-grid-match="{target:'.md-card-content'}">
            ...
            </div><?php foreach ($invoice

        as $invoice) { ?>-->
    <div class="uk-grid uk-grid-width-small-1-2 uk-grid-width-large-1-5 uk-grid-width-xlarge-1-5 uk-text-center uk-sortable sortable-handler"
        ...
        <div>
            <div class="md-card md-card-hover md-card-overlay" style="background-color:#f88529">
                <a href="<?php echo site_url(); ?>/manageOrder">
        ...
        <div class="">
            <div class="md-card md-card-hover md-card-overlay" style="background-color: rgb(255, 102, 0);;">
                <a href="<?php echo site_url(); ?>/manageOrder">
                    <div class="md-card-content uk-flex uk-flex-center uk-flex-middle">
                        <span style="font-size:35px;color:white;"><h2 style="color:white"
                                                                      class="uk-icon-gbp">&nbsp;<?php if ($invoice['total']) {
                                    $total_amount = $invoice['total'];
                                    echo number_format($total_amount, 2);
                                } else {
                                    echo number_format(0, 2);
                                } ?></h2><br><b style="font-size: 26px;">Total Amount</b></span>
                    </div>
                    <div class="md-card-overlay-content">
                        <div class="uk-clearfix md-card-overlay-header">
                        </div>
        ...
        <div class="">
            <div class="md-card md-card-hover md-card-overlay" style="background-color:#b0de09;">
                <a href="<?php echo site_url(); ?>/manageOrder">
                    <div class="md-card-content uk-flex uk-flex-center uk-flex-middle">
                        <span style="font-size:35px;color:white;"><h2 style="color:white"
                                                                      class="uk-icon-gbp">&nbsp;<?php if ($data[0]['total_paid']) {
                                    echo number_format($data[0]['total_paid']);
                                } else {
                                    echo number_format(0, 2);
                                } ?></h2><br><b style="font-size: 26px;">Total Paid</b></span>
                    </div>
                    <div class="md-card-overlay-content">
                        <div class="uk-clearfix md-card-overlay-header">
                        </div>
            ...
            <div class="md-card md-card-hover md-card-overlay" style="background-color:#52B9E9;">
                <a href="<?php echo site_url(); ?>/manageOrder">
                    <div class="md-card-content uk-flex uk-flex-center uk-flex-middle" style="background-color:#fcd202">
                        <span style="font-size:35px;color:white"><h2 style="color:white"
                                                                     class="uk-icon-gbp">&nbsp;<?php if ($invoice['pending']) {
                                    echo number_format($invoice['pending'], 2);
                                } else {
                                    echo number_format(0, 2);
                                } ?></h2><br><b style="font-size: 26px;"> Total Quotation</b></span>
                    </div>
                    <div class="md-card-overlay-content">
                        <div class="uk-clearfix md-card-overlay-header">
                        </div>
            ...
            <div class="md-card md-card-hover md-card-overlay" style="background-color: red;">
                <a href="<?php echo site_url(); ?>/manageCustomers">
                    <div class="md-card-content uk-flex uk-flex-center uk-flex-middle"
                        ...
                        <span style="color:white"><h2 style="color:white"><?php if ($total_customers[0]['customers']) {
    ...
    $(function () {
        ...
        calendar_selectable: function () {
            ...
            t.length && t.fullCalendar({
                header: {left: "title today", center: "", right: "month,agendaWeek,agendaDay,listWeek prev,next"},
                buttonIcons: {
                ...
                eventLimit: !0,
                timeFormat: "(HH)(:mm)",
                events: [<?php  $myArray = array();foreach ($calender_record as $record) {
                    $days1 = explode("/", $record['invoice_date']);
                    $days = $days1[0];
                    $months = $days1[1];
                    $years = $days1[2];
                    $id = $record['id'];
                    $day = $days - 1;
                    $myArray[] = "{ title:'" . $record['customer_person'] . "',url:'http://www.catermanage.co.uk/printOrder/" . $id . "',start:moment().startOf('month').add($day,'days').format('$years-$months-$days')}";
