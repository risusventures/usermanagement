                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="#" data-uk-tooltip="{pos:'bottom'}" Title="edit"
                                       data-uk-modal="{target:'#modal_header_footer_<?php echo $item['non_veg_id']; ?>'}"><i
                                                class="material-icons" style="font-size:28px;color:#1976D2;"></i></a>
                                    <div class="uk-modal" id="modal_header_footer_<?php echo $item['non_veg_id']; ?>"
                                        ...
                                        <input type="hidden" name="uid" class="md-input label-fixed"
                                               value="<?php echo $item['non_veg_id']; ?>" data-parsley-id="4">
                                                ...
                                                <div class="md-card-content large-padding">
                                                    ...
                                                    <div class="uk-grid " data-uk-grid-margin="">
                                                            ...
                                                            <div class="parsley-row">
                                                                <div class="md-input-wrapper md-input-filled"><label>Item
                                                                        Name<span class="req">*</span></label><input
                                                                            ...
                                                                            value="<?php echo $item['non_veg_name']; ?>"
                                                        ...
                                                        <div class="uk-width-medium-1-2">
                                                            <div class="parsley-row">
                                                                <div class="md-input-wrapper md-input-filled"><label>Item
                                                                        Ammount<span class="req">*</span></label><input
                                                                            type="text" name="item_ammount"
                                                                            class="md-input label-fixed"
                                                                            value="<?php echo $item['non_veg_ammount']; ?>"
                                                                            data-parsley-id="4" required><span
                                                                            class="md-input-bar"></span></div>
                                                            </div>
                                                        </div>
                                    ...
                                    <a href="<?php echo base_url() ?>seller/delete_non_veg_item/<?php echo $item['non_veg_id']; ?>"
        ...
        <div class="md-card">
            <div class="md-card-content large-padding">
                ...
                <div class="uk-grid " data-uk-grid-margin="">
                    ...
                    <div class="uk-width-medium-1-2">
                        <div class="parsley-row">
                            <div class="md-input-wrapper"><label for="fullname">Item Ammount<span
                                            class="req">*</span></label><input type="text" name="item_ammount"
                                                                               class="md-input" value=""
                                                                               data-parsley-id="4" required><span
                                        class="md-input-bar"></span></div>
                        </div>
