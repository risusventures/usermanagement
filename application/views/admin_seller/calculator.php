...
<head>
    ...
    <link rel="stylesheet" type="text/css" media="screen"
          href="<?php echo base_url(); ?>assets/calculator/jquery-nightowl-1.2.css"/>
...
<div class="main-content">
    <div class="main-content-inner content-width">
        <div class="column-container mid_container" style="float:right;">
            <center>
                <div class="column-one-qtr">
                    <div id="portfolio-blog-slider-container">
                        <!-- CALCULATOR -->
                        <center>
                            <div class="night_owl" style="color:white;"
                                 data-nightowl='{"drag":false, "subline":"Scientific Calculator", "title": "Finacbooks" }'></div>
                        </center>
                    </div>
                </div>
            </center>
