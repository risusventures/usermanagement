...
<head>
    ...
    <style>
        ...
        .ui-state-default, .ui-widget-content .ui-state-default, .ui-widget-header .ui-state-default {
            ...
            background: #09c 50% 50% repeat-x !important;
            font-weight: normal;
            color: #fff !important;
        }
...
<div id="page_content" style="margin-left:0px;">
    <div id="page_content_inner">
        ...
        <div class="">
            ...
            <main>
                <section class="mb-5" style="background: white; padding: 15px;">
                    ...
                    <div class="card card-cascade narrower">
                        ...
                        <div class="view view-cascade py-3 gradient-card-header info-color-dark mx-4 d-flex justify-content-between align-items-center">
                            ...
                            <div style="float: right;">
                                ...
                                <input class="btn btn-outline-white btn-rounded btn-sm px-2 waves-effect waves-light"
                                       id="e1" name="chart_filter">
                                <button class="md-btn md-btn-primary" type="submit"  style="height:30px;"/><i class="material-icons" style="color: white;">search</i></button>
                                <?php echo form_close(); ?>
            ...
            <div class="md-card-content">
                <div class="md-cardsss">
                    ...
                    ?>
                    <main>
                        <section class="mb-5" style=" background: white;padding: 15px;margin-top: 15px;">
                            ...
                            <div class="card card-cascade narrower">
                                ...
                                <!--Card header-->
                                <div class="view view-cascade py-3 gradient-card-header info-color-dark mx-4 d-flex justify-content-between align-items-center" style="background: #673ab7;padding: 10px;
">


                                    <a href="" class="white-text mx-3" style="font-size:20px;color:white;">Invoice Data</a>
...
">
                                    ...
                                    <a href="" class="white-text mx-3" style="font-size:20px;color:white;">Principal Collection</a>
...
">
                                    ...
                                    <a href="" class="white-text mx-3" style="font-size:20px;color:white;">Product Data</a>
        ...
        calendar_selectable: function () {
            ...
            t.length && t.fullCalendar({
                ...
                events: [<?php  $myArray = array();foreach ($calender_record as $record) {
                    ...
                    $id = $record['id'];
                    $day = $days - 1;
                    $myArray[] = "{ title:'" . $record['customer_person'] . "',url:'http://www.catermanage.co.uk/palmbeach/printOrder/" . $id . "',start:moment().startOf('month').add($day,'days').format('$years-$months-$days')}";
