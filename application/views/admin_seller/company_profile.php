    ...
    <div class="md-card">
        <div class="user_heading">
            ...
            <div class="user_heading_avatar" style="background-image:none;float:right;">
                <img class=""
                     src="<?php echo base_url() ?>assets/file_icon/profile_image/thum/<?php if ($records2[0]['image']) {
                         echo $records2[0]['image'];
                     } else {
                         echo 'dummy1.jpg';
                     }; ?>" alt="user avatar"
                            ...
                            <?php foreach ($account_detail as $detail) {
                                ...
                                <li>
                                    ...
                                    <div class="md-list-content">
                                        ...
                                        <span style="float:right;position:relative;">Verified<i class="material-icons"
                                ...
                                <li>
                                    <div class="md-list-content">
                                            ...
                                            <div class="uk-grid uk-grid-width-small-1-2 uk-grid-width-large-1-3 uk-grid-width-xlarge-1-4 uk-text-center uk-sortable sortable-handler"
                                                 id="dashboard_sortable_cards" data-uk-sortable=""
                                                 data-uk-grid-margin="">
                   ...
                   <div class="md-card md-card-hover " style="background-color:#f88529">
                    ...
                    <div class="md-card-content uk-flex uk-flex-center uk-flex-middle">
                     <span style="font-size:35px;color:white"><b style="font-size:17px;"><i class="material-icons"
                                                                                            style="font-size:27px;color:white"></i><br>Sales</b></span></span>
                                    </div>
                                    </a>
                        </div>
                    </div>
                    <div>
                        <div class="md-card md-card-hover" style="background-color: rgba(0, 128, 0, 0.68);">
                            <a href="<?php echo base_url(); ?>seller/view_order" style='text-decoration:none;'>
                                <div class="md-card-content uk-flex uk-flex-center uk-flex-middle">
                                    <span style="font-size:35px;color:white;"><b style="font-size: 17px;"><i
                                                    class="material-icons" style="font-size:27px;color:white">shopping_cart</i><br>Invoices</b></span>
                                </div>
                            </a>
                        </div>
                    </div>
                            ...
                            <a href="<?php echo base_url(); ?>seller/list_customers" style='text-decoration:none;'>
                                <div class="md-card-content uk-flex uk-flex-center uk-flex-middle">
                                    <span style="font-size:35px;color:white;"><b style="font-size:17px;"><i
                                                    ...
                                                    style="font-size:27px;color:white">group</i><br>Customers</b></span>
                                </div>
                            </a>
                        </div>
                    </div>
                        ...
                        <div class="md-card md-card-hover" style="background-color:#52B9E9;">
                            <a href="<?php echo base_url(); ?>seller/password" style='text-decoration:none;'>
                                <div class="md-card-content uk-flex uk-flex-center uk-flex-middle"
                                    ...
                                    <span style="font-size:35px;color:white"><b style="font-size:17px;"><i
                                                    class="material-icons"
                                                    style="font-size:27px;color:white">&#xE0DA;</i><br>Password</b></span>
                                </div>
                            </a>
                        </div>
                    </div>
...
<li aria-hidden="true">
    <ul class="md-list">
        ...
        <li>
            <div class="md-list-content">
                <span class="md-list-heading"><a
                            href="#">Ullam est ut repellendus omnis voluptas eveniet tempora.</a></span>
                <div class="uk-margin-small-top">
                                                <span class="uk-margin-right">
                                                    <i class="material-icons"></i> <span
        ...
        <li>
            <div class="md-list-content">
                <span class="md-list-heading"><a
                            href="#">Tenetur sed et numquam voluptates ad delectus iusto.</a></span>
                <div class="uk-margin-small-top">
                                                <span class="uk-margin-right">
                                                    <i class="material-icons"></i> <span
        ...
        <li>
            <div class="md-list-content">
                <span class="md-list-heading"><a
                            href="#">Voluptatem nihil harum soluta autem sit accusamus odit.</a></span>
                <div class="uk-margin-small-top">
                                                <span class="uk-margin-right">
                                                    <i class="material-icons"></i> <span
                                                            class="uk-text-muted uk-text-small">21 Nov 2015</span>
        ...
        <li>
            <div class="md-list-content">
                <span class="md-list-heading"><a
                            href="#">Praesentium ut deserunt expedita unde totam repellendus.</a></span>
                <div class="uk-margin-small-top">
                                                <span class="uk-margin-right">
                                                    <i class="material-icons"></i> <span
        ...
        <li>
            <div class="md-list-content">
                <span class="md-list-heading"><a
                            href="#">Et ipsa eius aut voluptates expedita officiis libero optio.</a></span>
                <div class="uk-margin-small-top">
                                                <span class="uk-margin-right">
                                                    <i class="material-icons"></i> <span
