        ...
        <div class="md-card">
            <div class="md-card-content large-padding">
                <?php foreach ($results->result() as $row) { ?>
                    <?php echo form_open(site_url('Seller/update_product_id'), array('id' => 'contactname', 'name' => 'contactname', 'class' => 'uk-form-stacked', 'onsubmit' => 'return validateentry();', 'enctype' => 'multipart/form-data')); ?>
                        ...
                        <div class="user_heading" data-uk-sticky="{ top: 48, media: 960 }" style="padding-right:10px;">
                            <div class="user_heading_avatar fileinput fileinput-new" data-provides="fileinput">
                                <div class="fileinput-new thumbnail">
                                    <img src="<?php echo base_url() ?>upload/<?php echo $row->image; ?>"
                                         alt="user avatar" style="background-image:none"/>
                                </div>
                                ...
                                <div class="user_avatar_controls">
                                        <span class="btn-file">
                                            ...
                                            <input type="file" name="image" id="user_edit_avatar_control" onchange=""
...
<p id="back" onClick="showDiv2()" style="display:none;"><i class="material-icons"
                    ...
                    <div class="uk-grid" data-uk-grid-margin>
                        <div class="uk-width-1-1">
                            <div class="parsley-row">
                                <div class="md-input-wrapper md-input-wrapper-success"><label
                                            for="message">Description</label><textarea
                                            style="overflow-x: hidden;  height: 21px;"
                                            class="md-input autosize_init md-input-success" name="description" cols="10"
                                            rows="8"
                                            style="height:auto;"><?php echo $row->producty_description; ?></textarea><span
                    ...
                    <div class="uk-grid">
                        <div class="uk-width-1-1">
                            <button type="submit" class="md-btn md-btn-primary" onClick="return ConfirmDialog()">
                                Submit
                            </button>
                        </div>
                    </div>
