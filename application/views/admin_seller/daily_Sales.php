                    ...
                    <div class="md-card-content">
                        <div class="uk-grid" data-uk-grid-margin>
                            <div class="uk-width-large-1-1">
                                    ...
                                    <div class="uk-grid" data-uk-grid-margin="">
                                        <div class="uk-width-large-1-2 uk-width-medium-1-1">
                                            <div class="uk-input-group">
                                                ...
                                                <div class="md-input-wrapper"><label for="uk_dp_start">Start
                                                        Date</label><input class="md-input" type="text" id="uk_dp_start"
                                                                           name="start_date" required><span
                                        ...
                                        <div class="uk-width-large-1-2 uk-width-medium-1-1">
                                            <div class="uk-input-group">
                                                <span class="uk-input-group-addon"><i
                                                            class="uk-input-group-icon uk-icon-calendar"></i></span>
                                                <div class="md-input-wrapper"><label for="uk_dp_end">End
                                                        Date</label><input class="md-input" type="text" id="uk_dp_end"
                                                                           name="end_date" required><span
                                                            class="md-input-bar"></span></div>
                                ...
                                <br><br><br>
                                <div class="uk-width-medium-1-4"><input type="submit" class="md-btn md-btn-primary"
                                                                        href="#" value="Search Sales" name="submit">
                                </div>
                                <br><br>
                                            ...
                                            <div class="uk-grid uk-grid-width-small-1-2 uk-grid-width-large-1-3 uk-grid-width-xlarge-1-4 uk-text-center uk-sortable sortable-handler"
                                                ...
                                                <div>
                                                    <div class="md-card md-card-hover md-card-overlay"
                                                        ...
                                                        <div class="md-card-content uk-flex uk-flex-center uk-flex-middle">
                                                            <span style="font-size:35px;color:white;"><h2
                                                                        style="color:white">RS.<?php if ($key['subtotal'] == null) {
                                                                        echo '0';
                                                                    } else {
                                                                        echo $key['subtotal'];
                                                                    } ?>/-</h2><b
                                                                        style="font-size: 26px;">Total Amount</b></span>
                                                        </div>
                                                        <div class="md-card-overlay-content">
                                                            <div class="uk-clearfix md-card-overlay-header">
                                                            </div>
                                                ...
                                                <div>
                                                    ...
                                                    <div class="md-card md-card-hover md-card-overlay"
                                                        ...
                                                        <div class="md-card-content uk-flex uk-flex-center uk-flex-middle">
                                                            <span style="font-size:35px;color:white;"><h2
                                                                        style="color:white">Rs.<?php if ($key['paid'] == null) {
                                                                        echo '0';
                                                                    } else {
                                                                        echo $key['paid'];
                                                ...
                                                <div>
                                                    <div class="md-card md-card-hover md-card-overlay"
                                                         style="background-color:#52B9E9;">
                                                        <div class="md-card-content uk-flex uk-flex-center uk-flex-middle"
                                                             style="background-color: rebeccapurple">
                                                            <span style="font-size:35px;color:white"><h2
                                                                        style="color:white">Rs.<?php if ($key['pending'] == null) {
                                                                        echo '0';
                                                                    } else {
                                                                        echo $key['pending'];
                                                                    } ?></h2><b
                                                                        style="font-size: 26px;">Pending</b></span>
                                                        </div>
                                                        <div class="md-card-overlay-content">
                                                            <div class="uk-clearfix md-card-overlay-header">
                                                            </div>
