...
<div id="wrap" style="width:800px;margin:auto;border:1px solid;">
    <?php if(array_key_exists(0,$order_sheet)){ if($order_sheet[0]['status'] == 'Paid') {
    ...
    ?>
    <div class="row-fluid">
        <div style="float: left;"><img src="<?php echo base_url(); ?>assets/img/risus-03.png" alt=""
                                       style="height: 128px;position: absolute;top: 6px;"/></div>
        <div style="float: right; position: relative; right: 323px; top: -35px;">
            <!--<img src="<?php echo base_url(); ?>assets/img/full_logo.png" alt="" />--><h3 style="font-size:40px;    margin-top: 40px;
    margin-left: 30px;"><?php if(array_key_exists(0,$order_sheet)){ if ($order_sheet[0]['status'] == 'Quotation') {
                    echo 'Quotation';
                } else {
                    echo 'Invoice';
                } 
    ...
    <div class="row-fluid" style="clear: both;padding-top: 24px;">
        ...
        <div class="span6" style="float:left;">
            ...
            ?>
            <p style="font-weight:bold;">Date : <?php echo $row['orderdate']; ?></p>

            <!--<p style="font-weight:bold;">Event Venue : <?php echo $row['event_venue']; ?></p>-->
        </div>


        <div class="span6" style="float:right;margin-top:0px;line-height:19px;margin-right: 100px;">
            ...
            <!--<p>Email<span style="margin-left:15px;"> : <?php echo $customer_contacts['customer_email']; ?></span></p>-->
            <br><br><br>


            <p style="font-weight:bold;">Invoice No.: <?php echo $row['invoice_no']; ?></p>
            <p style="font-weight:bold;">Order No.: <?php echo $row['id']; ?></p>
            <?php } ?>
        </div>
    </div>
    ...
    <div class="row-fluid">
        ...
        <table class="table table-bordered table-hover table-striped"
               style="margin-bottom: 5px;width:100%;    font-size: 15px;">
            <thead>
            <tr>
            ...
            <tr>
                ...
                <td style="text-align:right; font-weight:bold;">
                    <?php echo $invoice_product[0]['acceptmoney'] . ' USD'; ?>
        ...
        <div class="row-fluid">
            <?php foreach ($invoice_product as $row) {
                ...
                ?>
                <div>
                    <h6 style="background-color:rgba(193, 193, 193, 0.4);padding: 10px 0px 10px 10px;"><b
                                style="font-weight: bold;font-size:18px;">Note</b></h6>
...
">
            ...
            <?php if(!empty($_GET['without'])){ if ($_GET['without'] != 'payment') { ?>
                <div class="span4 pull-left">

                    <p>&nbsp;</p>
                    <h6 style="background-color:rgba(193, 193, 193, 0.4);padding: 10px 0px 10px 10px;"><b
                                style="font-weight: bold;font-size:18px;">Terms & Conditions</b></h6>
                    <ul style="font-size:10px;">
                        <li>Quotations are valid for 8 weeks. All bookings are subject to minimum guest numbers.</li>
                        <li>A non-refundable deposit of 25% is required to secure Catering for the date of your event.
                        </li>
                        <li>Deposit will be deducted from the total event costs, final funds should be cleared 3 days
                            prior to the event
                        </li>
                        <li>Service staff price is based on 6 hours, additional hours are charged at £8.50 per hour per
                            person
                        </li>
                        ...
                        <li>In booking cancellations, your deposit will be retained and the following charges will be
                            incurred
                        </li>
                        <li>Cancellation received within 7 working days of event – 50% of total event cost, within 3
                            working days of event – 100% of the total event cost
                        </li>
                        <li>We shall incur no liability if performance of the contract is prevented or hindered by any
                            case whatsoever beyond our control and shall not be liable for any loss or damage resulting
                            there from suffered by customer.
                        </li>
                    </ul>
                </div>
            <?php } } ?>
