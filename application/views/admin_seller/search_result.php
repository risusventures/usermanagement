                    ...
                    <div class="md-card md-card-hover-img">
                        <div class="md-card-head uk-text-center uk-position-relative">
                            <img class="md-card-head-img"
                                 src="<?php echo base_url(); ?>upload/<?php echo $records[0]['image']; ?>"
                        ...
                        <div class="md-card-content">
                            <h4 class="heading_c uk-margin-bottom">
                                ...
                                <span class="   sub-heading"
                                      style=""><strong>Rs.</strong><span><?php echo $records[0]['price']; ?></span><strong>/</strong><?php echo $records[0]['per']; ?></span>
                            </h4>
                            <p></p>
                            <a href="<?php echo site_url() ?>seller/view_product/<?php echo $records[0]['id']; ?>">
                            ...
                            <div class="md-card-head-menu" data-uk-dropdown="{pos:'bottom-right'}" aria-haspopup="true"
                                ...
                                <div class="uk-dropdown uk-dropdown-small uk-dropdown-bottom"
                                    ...
                                    <ul class="uk-nav">
                                        <li>
                                            <a href="<?php echo site_url() ?>/seller/edit_product_id/<?php echo $records[0]['id']; ?>">Edit</a>
                                        </li>
                                        <li>
                                            <a href="<?php echo site_url() ?>/seller/delete_product_id/<?php echo $records[0]['id']; ?>"
