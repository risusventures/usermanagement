...
<div id="page_content" style="margin-left:0px;">
    <div id="page_content_inner">
        <h4 class="heading_a uk-margin-bottom"><?php if ($month_report == '12' || $month_report == '6' || $month_report == '3') {
                echo 'Last&nbsp&nbsp' . $month_report . '&nbsp&nbspmonth Reports';
            } elseif ($month_report == 'current') {
                echo $month_report . '&nbspMonth &nbspReports';
            } else {
                echo 'Last&nbsp' . $month_report . '&nbspReports';
            } ?></h4>
        <div class="md-card uk-margin-medium-bottom">
            <div class="uk-button-dropdown" data-uk-dropdown="{mode:'click'}" aria-haspopup="true"
                 aria-expanded="false">
                <button class="md-btn">Filter<i class="material-icons" style="color:white;"></i></button>
                <?php echo form_open(site_url('searchRecords')); ?>
                <div class="uk-dropdown uk-dropdown-bottom" style="min-width: 320px; top: 35px; left: 0px;">
                    <ul class="uk-nav uk-nav-dropdown">
                        ...
                        <li><a href="#"><select style="width:100%;height:30px;" name="status">
                        ...
                        <li><a href="#">
                                <select style="width:100%;height:30px;" onchange='CheckColors(this.value);'
                                        id="quantityReturn" class="form-control" id="uk_dp_end" name="month_report">
                        ...
                        <li></li>
                        <li><a href="#"><input type="submit" class="md-btn md-btn-primary" href="#" value="Update"
                                               name="Update"></a></li>
                    </ul>
                </div>
                <?php echo form_close(); ?>
                        ...
                        <tr>
                            ...
                            <td><?php $status = $filter['status'];
                                if ($status == 'Pending') {
                                    ...
                                    echo '<span class="uk-badge uk-badge-success" style="padding: 3px 29px;background-color:#51A851;">' . $filter['status'] . '</span>';
                                }
                                ?></td>
