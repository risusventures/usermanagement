...
<?php echo form_open(site_url('seller/add_order'), array('id' => 'ClassSearch', 'name' => 'ClassSearch', 'class' => 'uk-form-stacked', 'onsubmit' => 'return(validate());', 'enctype' => 'multipart/form-data')); ?>
                ...
                <div class="form-group">
                    <textarea class="form-control" rows='3' id="companyAddress" placeholder="Your Address" name="buyer_address" readonly><?php echo $row['address']; ?>  <?php echo $row['postal_code']; ?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            ?>
                                            <!--<input type="text" class="form-control" id="companyName" placeholder="Company Name" name="buyer_company_name" value="<?php echo $row['company_name']; ?>"  readonly>-->
                                            <b><p>Principal Assigned Customer</p></b>
                                            <div class="form-group">
                                                <?php foreach ($list_principal

                                                as $principal) {
                                                $principalid = $principal['Principal_id'];

                                                $query = $this->db->query("SELECT DISTINCT `cid` FROM `customers_principal_assigned` WHERE `pid`= '$principalid'");
                                                $data = $query->result_array();
                                                $queryproduct = $this->db->query("SELECT * FROM `customers_principal_assigned` WHERE `pid`= '$principalid'");
                                                $dataproduct = $queryproduct->result_array();

                                                ?>
                                            </div>


                                            <div name="pcheck[]" class="ptable"
                                                 id="table<?php echo $principal['Principal_id']; ?>"
                                                 style="display:none;">
                                                <?php
                                                if (!empty($data)) {
                                                    foreach ($data as $singalproducts) {
                                                        ...
                                                        <label><input type="checkbox" name="productcheck[]"
                                                                      class="productcheck"
                                                                      id="mytable<?php echo $singalproducts['cid']; ?>"
                                                                      onclick="showproduct()"
                                                                      value="<?php echo $singalproducts['cid'] ?>"><?php $customer_name = $singalproducts['cid'];
                                                            $query = $this->db->query("SELECT `customer_person` FROM `customers` WHERE `customer_id`= '$customer_name'");
                                                            $data1 = $query->row_array();
                                                            echo $data1['customer_person']; ?></label>
                                                        <br>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <?php // echo'<pre>'; print_r($dataproduct);echo'</pre>';

                                            foreach ($dataproduct as $customerp_id) {
                                                ...
                                                <table class="producttable" style="display:none"
                                                       id="tables<?php echo $customerp_id['cid']; ?>">
                                                    <caption
                                                            style=" font-size: 20px;font-weight: bold;text-align: left;"><?php echo $customerp_id['cid']; ?></caption>
                                                    <thead>
                                                    <tr>
                                                        <th>Products</th>
                                                        <th>Price</th>
                                                    ...
                                                    <tr>
                                                        <td><?php echo $customerp_id['product_id']; ?><?php echo '<pre>';
                                                            print_r($customerp_id);
                                                            echo '</pre>'; ?></td>
                                                        <td><input type="text"
                                                                   value="<?php echo $singalproducts ['product_price']; ?>"
                                                ...
                                                <?php // echo'<pre>'; print_r($customerp_id['id']); echo'</pre>';
                                            }
                                            }
                                            ?>
                                        ...
                                        <div class="form-group">
        <textarea class="form-control" rows='3' id="companyAddress" placeholder="Your Address" name="buyer_address"
                  readonly><?php echo $row['address']; ?><?php echo $row['postal_code']; ?>
           </textarea>
                                        </div>
                                        <div class="form-group">
                                            <input type="text" class="form-control" id="datepicker1"
                                                   placeholder="Order Date" id="invoiceDate1" name="party_date"
                                                   Required>
                                        </div>
                                        <div class="form-group">

                                            <input type="text" class="form-control" id="datepicker"
                                                   placeholder="Event Date" id="invoiceDate" name="invoice_date[]"
                                                   Required>
                                        </div>

                                        <div class="form-group">
                                            <textarea class="form-control" rows="5" id="" placeholder="Note"
                                                      name="note"></textarea>
                                        </div>
                                    ...
                                    <div class="col-md-5">
                                        ...
                                        <div class="form-group">
                                            <select id="select_demo_5" name="seller_company_name"
                                                    title="Select with tooltip" class="buyer form-control">
                                        ...
                                        <div class="form-group">
                                            <input type="text" name="seller_email" id="seller_email "
                                                   class="form-control seller_email" placeholder="Customer Email"
                                                   id="category1" value="" required>
                                        </div>
                                        <div class="form-group">
                                            <textarea class="form-control seller_address" rows='3' id="clientAddress"
                                                      placeholder="Customer Address" name="seller_address"></textarea>
                                        </div>

                                        <div class="form-group">
                                            <textarea class="form-control" rows='3' id="" placeholder="Event Venue"
                                                      name="event_venue"></textarea>
                                        </div>
                                        <div class="form-group">

                                            <input class="form-control" type="text" id="uk_tp_1" name="event_time"
                                                   placeholder="Select Time" data-uk-timepicker>
                                        </div>
                                        <div class="form-group">
                                            <input type="text" class="form-control" rows='3' id=""
                                                   placeholder="Enter Number Of Guest" name="num_guest">
                                        </div>
                                    </div>
                                    ...
                                    <div class='col-xs-12 col-sm-12 col-md-12 col-lg-12' style="overflow-x:auto;">
                                        <table class="table table-bordered table-hover item_equipment">
                                            ...
                                            <tr>
                                                ...
                                                <td><select class="select2  autocomplete_txt form-control"
                                                            id="itemName_1 select_demo_5" autocomplete="off"
                                                            data-type="productName" name="itemName[]"
                                                ...
                                                <td><input type="text" name="price[]" id="price_1"
                                                           class="form-control changesNo" autocomplete="off"
                                                           onKeyPress="return IsNumeric(event);" ondrop="return false;"
                                                           onpaste="return false;" style="width: 100%;"></td>
                                                <td><input type="text" name="quantity[]" id="quantity_1"
                                                           class="form-control changesNo" autocomplete="off"
                                                           onKeyPress="return IsNumeric(event);" ondrop="return false;"
                                                           onpaste="return false;" style="width: 100%;"></td>
                                                <td><input type="text" name="total[]" id="total_1"
                                ...
                                <div class='row'>
                                    <div class='col-xs-12 col-sm-3 col-md-3 col-lg-3' style="margin-top:10px;">
                                        ...
                                        <button class="btn btn-success addmore_equipment" type="button"
                                                style="background-color:#1976D2;border-color:#1976D2">+ Add More
                                        </button>
                                    </div>
                                </div>

                                <button class="btn btn-primary nextBtn btn-lg pull-right" type="button"
                                        style="margin-top:10px;">Next
                                </button>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="col-md-6" style="">
                                    ...
                                    <div style="overflow-x:auto;">
                                        <table class="order-list table table-bordered table-hover veg_item">
                                            ...
                                            <tr>
                                                <td>
                                                    <input type="hidden" name="veg_total_item" id="veg_total_item"
                                                           value="1">
                                                    <select class="select2  autocomplete_txt form-control" id=""
                                                            autocomplete="off" data-type="productName"
                                                            name="vegproduct1" data-placeholder="Choose ..."
                                                            style="width: 100%;">
                                                        <option value="">Choose One</option>
                                                ...
                                                <td><input type="text" name="vegprice1" id=""
                                                           class="form-control changesNo" autocomplete="off"
                                                           onKeyPress="return IsNumeric(event);" ondrop="return false;"
                                                           onpaste="return false;" style="width: 100%;"></td>
                                                <td><input type="text" name="vegqty1" id=""
                                                           class="form-control changesNo" autocomplete="off"
                                                           onKeyPress="return IsNumeric(event);" ondrop="return false;"
                                                           onpaste="return false;" style="width: 100%;"></td>
                                                <td><input type="text" name="veglinetotal1" id=""
                                                           class="form-control totalLinePrice" autocomplete="off"
                                                           onKeyPress="return IsNumeric(event);" ondrop="return false;"
                                                           onpaste="return false;" style="width: 100%;"></td>
                                                <td></td>
                                            ...
                                            <tr>
                                                <td colspan="5" style="text-align: center;">
                                                    <input type="button" id="addmore_veg" value="Add Row"
                                                           class="btn btn-success addmore_veg"/>
                                                </td>
                                            </tr>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div style="overflow-x:auto;">
                                        <table class="order-list1 table table-bordered table-hover">
                                            ...
                                            <tr>
                                                <td>
                                                    <input type="hidden" name="non_veg_total_item"
                                                           id="non_veg_total_item" value="1">
                                                    <select class="select2 autocomplete_txt form-control" id=""
                                                            autocomplete="off" data-type="productName"
                                                            name="nonvegproduct1" data-placeholder="Choose ..."
                                                            style="width: 100%;">
                                                        <option value="">Choose One</option>
                                                ...
                                                <td><input type="text" name="nonvegprice1" id=""
                                                           class="form-control changesNo" autocomplete="off"
                                                           onKeyPress="return IsNumeric(event);" ondrop="return false;"
                                                           onpaste="return false;" style="width: 100%;"></td>
                                                <td><input type="text" name="nonvegqty1" id=""
                                                           class="form-control changesNo" autocomplete="off"
                                                           onKeyPress="return IsNumeric(event);" ondrop="return false;"
                                                           onpaste="return false;" style="width: 100%;"></td>
                                                <td><input type="text" name="nonveglinetotal1" id=""
                                                           class="form-control totalLinePrice" autocomplete="off"
                                                           onKeyPress="return IsNumeric(event);" ondrop="return false;"
                                                           onpaste="return false;" style="width: 100%;"></td>
                                                <td></td>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div style="overflow-x:auto;">
                                        <table class="order-list2 table table-bordered table-hover">
                                            ...
                                            <tr>
                                                <td>
                                                    <input type="hidden" name="cold_total_item" id="cold_total_item"
                                                           value="1">
                                                    <select class="select2 autocomplete_txt form-control" id=""
                                                            autocomplete="off" data-type="productName"
                                                            name="coldproduct1" data-placeholder="Choose ..."
                                                            style="width: 100%;">
                                                        <option value="">Choose One</option>
                                                ...
                                                <td><input type="text" name="coldprice1" id=""
                                                           class="form-control changesNo" autocomplete="off"
                                                           onKeyPress="return IsNumeric(event);" ondrop="return false;"
                                                           onpaste="return false;" style="width: 100%;"></td>
                                                <td><input type="text" name="coldqty1" id=""
                                                           class="form-control changesNo" autocomplete="off"
                                                           onKeyPress="return IsNumeric(event);" ondrop="return false;"
                                                           onpaste="return false;" style="width: 100%;"></td>
                                                <td><input type="text" name="coldlinetotal1" id=""
                                                           class="form-control totalLinePrice" autocomplete="off"
                                                           onKeyPress="return IsNumeric(event);" ondrop="return false;"
                                                           onpaste="return false;" style="width: 100%;"></td>
                                                <td></td>
                                            ...
                                            <tr>
                                                <td colspan="5" style="text-align: center;">
                                                    <input type="button" id="addrow_cold" value="Add Row"
                                                           class="btn btn-success addmore"/>
                                                </td>
                                            </tr>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div style="overflow-x:auto;">
                                        <table class="order-list3 table table-bordered table-hover">
                                            ...
                                            <tr>
                                                <td>
                                                    <input type="hidden" name="desert_total_item" id="desert_total_item"
                                                           value="1">
                                                    <select class="select2 autocomplete_txt form-control" id=""
                                                            autocomplete="off" data-type="productName"
                                                            name="desertproduct1" data-placeholder="Choose ..."
                                                            style="width: 100%;">
                                                ...
                                                <td><input type="text" name="desertprice1" id=""
                                                           class="form-control changesNo" autocomplete="off"
                                                           onKeyPress="return IsNumeric(event);" ondrop="return false;"
                                                           onpaste="return false;" style="width: 100%;"></td>
                                                <td><input type="text" name="desertqty1" id=""
                                                           class="form-control changesNo" autocomplete="off"
                                                           onKeyPress="return IsNumeric(event);" ondrop="return false;"
                                                           onpaste="return false;" style="width: 100%;"></td>
                                                <td><input type="text" name="desertlinetotal1" id=""
                                                           class="form-control totalLinePrice" autocomplete="off"
                                                           onKeyPress="return IsNumeric(event);" ondrop="return false;"
                                                           onpaste="return false;" style="width: 100%;"></td>
                                                <td></td>
                                            ...
                                            <tr>
                                                <td colspan="5" style="text-align: center;">
                                                    <input type="button" id="addrow_desert" value="Add Row"
                                                           class="btn btn-success addmore"/>
                                                </td>
                                            </tr>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div style="overflow-x:auto;">
                                        <table class="order-list4 table table-bordered table-hover">
                                            ...
                                            <tr>
                                                <td>
                                                    <input type="hidden" name="other_total_item" id="other_total_item"
                                                           value="1">

                                                    <input type="text" name="otherproduct1" id=""
                                                           class="form-control changesNo" style="width: 100%;">
                                                </td>
                                                <td><input type="text" name="otherprice1" id=""
                                                           class="form-control changesNo" autocomplete="off"
                                                           onKeyPress="return IsNumeric(event);" ondrop="return false;"
                                                           onpaste="return false;" style="width: 100%;"></td>
                                                <td><input type="text" name="otherqty1" id=""
                                                           class="form-control changesNo" autocomplete="off"
                                                           onKeyPress="return IsNumeric(event);" ondrop="return false;"
                                                           onpaste="return false;" style="width: 100%;"></td>
                                                <td><input type="text" name="otherlinetotal1" id=""
                                                           class="form-control totalLinePrice" autocomplete="off"
                                                           onKeyPress="return IsNumeric(event);" ondrop="return false;"
                                                           onpaste="return false;" style="width: 100%;"></td>
                                                <td></td>
                                            ...
                                            <tr>
                                                <td colspan="5" style="text-align: center;">
                                                    <input type="button" id="addrow_other" value="Add Row"
                                                           class="btn btn-success addmore"/>
                                                </td>
                                            </tr>
                ...
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" id="tax" placeholder="Discount" name="tax"
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <div class="input-group-addon menu_icon uk-icon-gbp"></div>
                            <input type="text" class="form-control" id="taxAmount" name="tax_amount" placeholder="Tax"
                                   onKeyPress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;"
                                   readonly>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <div class="input-group-addon menu_icon uk-icon-gbp"></div>
                            <input type="text" class="form-control" id="totalAftertax" name="total_amount"
...
<script>
    function showproduct() {
        $(".producttable").hide();
        var amenatie = $('input:checkbox:checked.productcheck').map(function () {
            return this.value;
        }).get();
...
//adds extra table rows
    ...
    var prices = [<?php foreach ($records as $row) {
        echo '"' . $row['productCode'] . '|' . $row['productName'] . '|' . $row['buyPrice'] . '",';
    }?>];
