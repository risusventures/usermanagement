...
<div id="wrap" style="width:800px;margin:auto;border:1px solid;padding: 20px; ">
    ...
    <div class="row-fluid" style="clear: both; padding-top: 24px;">
        <div style="float:left; width:40%">
            <img src="<?php echo base_url(); ?>assets/img/risus-03.png" alt=""
                 style="height: 128px;position: absolute;top: 6px;"/>
        </div>
  ...
  "><?php echo 'Invoice'; ?> </h3>
    ...
    <div class="row-fluid" style="clear: both; padding-top: 24px;">
        ...
        <div style="float:right;margin-top:0px;line-height:19px;width:40%">
            ...
            <p style="margin: 0 0 5px;">Email<span
                        style="margin-left:15px;"> : <?php echo $customer_contacts['customer_email']; ?></span></p>
            <br><br><br>
        ...
        <table class="table table-bordered table-hover table-striped"
            ...
            <tr style="border-bottom: 1px solid black">
                ...
                <td style="text-align:right; font-weight:bold;">
                    ...
                    <?php if (!empty($invoice_product[0]['totalusd'])) {
                        echo $invoice_product[0]['totalusd'] . ' USD';
                        echo '<br>';
                    } ?>
                    <?php if (!empty($invoice_product[0]['totaleur'])) {
                        echo $invoice_product[0]['totaleur'] . ' EUR';
                        echo '<br>';
                    } ?>
