...
<head>
    ...
    <title>Add Sub-user - Risus Ventures</title>
    ...
    <div id="page_content_inner">
        ...
        <div class="md-card">
            <div class="md-card-content large-padding">
                ...
                <?php echo form_open(site_url('seller/saveuser'), array('id' => 'saveprincipal', 'name' => 'saveprincipal', 'onsubmit' => 'return validateentry();', 'class' => 'uk-form-stacked', 'enctype' => 'multipart/form-data')); ?>
                <div class="uk-grid " data-uk-grid-margin>

                    <div class="uk-width-medium-1-3">
                        <div class="parsley-row">
                            <label for="fullname">User Phone Number<span class="req">*</span></label>
                            <input type="number" name="user_number" class="md-input" value="" required/>
                        </div>
                    </div>
                    <div class="uk-width-medium-1-3">
                        <div class="parsley-row">
                            <label for="email">Email Address<span class="req">*</span></label>
                            <input type="email" name="user_email" class="md-input" value=""/>
                        </div>
                    </div>
                    <div class="uk-width-medium-1-3">
                        <div class="parsley-row">
                            <label for="fullname">Enter Password<span class="req">*</span></label>
                            <input type="password" name="user_password" class="md-input" value="" required/>
                        </div>
                    </div>
                </div>
                <div class="uk-grid " data-uk-grid-margin>
                    <div class="uk-width-medium-1-3">
                        <div class="parsley-row">
                            <select id="val_select" required data-md-selectize name="roleid" required>
                ...
                <div class="uk-grid " data-uk-grid-margin>
                    ...
                    <div class="uk-width-medium-1-6">
                        <div class="parsley-row">
                            ...
                            <input type="checkbox" id="myCheck2" name="menu[]" value="add_emails">Add Emails<br>
                            <input type="checkbox" id="myCheck2" name="menu[]" value="list_order_emails">List Order
                            Emails
                        </div>
                    </div>
                </div>
