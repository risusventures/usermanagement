...
<head>
    ...
    <title>Order report11 - Risus Ventures</title>
    <link rel="stylesheet"
...
<div id="page_content" style="margin-left:0px;">
    <div id="page_content_inner">
		<h3 class="heading_a uk-margin-bottom"><u>Order Report</u> <b style="float:right;">filter</b></h3>
                            ...
                            <div class="panel-body">
                                <div class="col-md-4">
                                    <div class="uk-form">
                                        ...
                                        <input type="text" id="orderdate" name="from_date"
                                ...
                                <div class="col-md-4">
                                    <div class="uk-form">
                                        <label>To date</label>
                                        <input type="text" id="orderdate" name="to_date"
                                               data-uk-datepicker="{format:'YYYY-MM-DD'}"
