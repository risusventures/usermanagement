    ...
    <div id="page_content_inner">
        ...
        <div class="md-card">
            <div class="md-card-content large-padding">
                ...
                <?php echo form_open(site_url('profile/create_contact'), array('id' => 'contactform', 'name' => 'contactform', 'onsubmit' => 'return validateentry();', 'class' => 'uk-form-stacked', 'enctype' => 'multipart/form-data')) ?>
                        ...
                        <div class="user_heading_avatar fileinput fileinput-new" data-provides="fileinput">
                            ...
                            <div class="user_avatar_controls">
                                    ...
                                    <input type="file" name="image" id="user_edit_avatar_control"
                                           onchange="check_upload(this)" value=""></span>
                ...
                <div class="uk-grid " data-uk-grid-margin>
                    ...
                    <div class="uk-width-medium-1-3">
                        <div class="parsley-row">
                            ...
                            <input type="text" name="email" class="md-input" value="<?php echo $user_email; ?>"
                                   readonly/>
                        </div>
                    </div>
                </div>
