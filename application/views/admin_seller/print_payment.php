...
<head>
    ...
    <title>    <?php foreach ($payment as $row) {
            echo 'Payment Order No.' . $row['invoice_no'];
        } ?></title>
...
<div id="wrap" style="width:600px;margin:auto;border:1px solid;">
    <center><img src="<?php echo base_url(); ?>assets/img/full_logo.png" alt="My Company Name"/></center>
    <br>
    <div class="row-fluid">
        <div class="span6">
            ...
            <?php foreach ($profile as $row) { ?>
                <h5><?php echo $row['company_name']; ?></h5><?php echo $row['address']; ?>,
                <br/><?php echo $row['city'] ?> , <?php echo $row['state']; ?> , <?php echo $row['postal_code']; ?>
                <br/>Tel: <?php echo $row['tele_number']; ?> , <?php echo $row['mobile_number']; ?>
    ...
    <div class="row-fluid">
        ...
        <table class="table table-bordered table-hover table-striped" style="margin-bottom: 5px;">
            ...
            <tr>
                ...
                <td style="width: 100px; text-align:right; vertical-align:middle;"><h4>
                        Rs.<?php echo $row['invoice_paid_amount']; ?></h4></td>
            </tr>
            </tbody>
        </table>
        <div class="row-fluid">
