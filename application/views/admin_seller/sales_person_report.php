            ...
            <div class="md-card-content">
                <div class="uk-grid" data-uk-grid-margin="">
                    <div class="uk-width-medium-5-10">
                        <div class="md-input-wrapper"><h2>Sales Person Report</h2><?php if (isset($_GET['submit'])) {
                                echo '<strong>Date : ' . $start_date . '&nbsp;To&nbsp;' . $end_date . '</strong>';
                    ...
                    <div class="uk-width-medium-3-10">
                        <div class="md-input-wrapper"><input class="raw" id="e1" name="chart_filter"
                                                             style="height:50px;font-size:15px;"><input type="submit"
                    ...
                    <div class="uk-width-medium-2-10">
                        <div class="md-input-wrapper"><h4><a href="#" onclick="myFunction()"><i
                                            class="md-icon material-icons">?</i>Refresh</a></h4></div>
                    </div>
                </div>
                <?php echo form_close(); ?>
            </div>
            ...
            <div style="">
                <div class="md-card">
                    <div class="md-card-content">
                        ...
                        <h2 class="uk-margin-remove"><span class="uk-icon-inr" style="font-size: 20px;">&nbsp;</span>
                        </h2>
                    </div>
                </div>
            </div>
