...
<div id="page_content" style="margin-left:0px;">
    <div id="page_content_inner">
        <div><h3 class="heading_a uk-margin-bottom">Manage products</h3>
            <p>
        ...
        <?php if(!empty($_GET['ab'])){ if ($_GET['ab'] == 1) {
            echo '<div class="uk-alert uk-alert-success" data-uk-alert="">
    <a href="#" class="uk-alert-close uk-close"></a>Product successfully added......</div>';
        } } ?>
        <?php
        ...
        <div class="uk-grid-width-small-1-2 uk-grid-width-medium-1-3 uk-grid-width-large-1-6 hierarchical_show"
                    ...
                    <div class="md-card md-card-hover-img">
                        <div class="md-card-head uk-text-center uk-position-relative">
                            <img class="md-card-head-img"
                                 src="<?php echo base_url(); ?>upload/<?php echo $row['image']; ?>"
                        ...
                        <div class="md-card-content">
                            <h4 class="heading_c uk-margin-bottom">
                                ...
                                <span class="   sub-heading"
                                      style=""><strong>Rs.</strong><span><?php echo $row['price']; ?></span><strong>/</strong><?php echo $row['per']; ?></span>
                            </h4>
                            <p></p>
                            <a href="<?php echo site_url() ?>viewProducts/<?php echo $row['id']; ?>">
                                <button class="md-btn" data-uk-modal="{target:'#modal_large'}">Read More</button>
                            </a>
                            <div class="md-card-head-menu" data-uk-dropdown="{pos:'bottom-right'}" aria-haspopup="true"
                                 aria-expanded="false">
                                <i class="md-icon material-icons"></i>
                                <div class="uk-dropdown uk-dropdown-small uk-dropdown-bottom"
                                     style="min-width: 160px; top: 32px; left: -128px;">
                                    <ul class="uk-nav">
                                        <li>
                                            <a href="<?php echo base_url() ?>editProduct/<?php echo $row['id']; ?>">Edit</a>
                                        </li>
                                        <li>
                                            <a href="<?php echo base_url() ?>seller/delete_product_id/<?php echo $row['id']; ?>"
                                               onclick="return ConfirmDialog()">Remove</a></li>
                                    </ul>
                                </div>
                            </div>
...
<div class="md-fab-wrapper">
    <a class="md-fab md-fab-accent" href="<?php echo site_url('addProducts'); ?>" id="recordAdd" title="Add New Product"
