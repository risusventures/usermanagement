    ...
    <div id="page_content_inner">
        ...
        <div class="md-card">
            <div class="md-card-content large-padding">
                <form id="form_validation" name="contactform" id="contactform"
                      action="<?php echo base_url() ?>notification_ctrl/add_notification" class="uk-form-stacked"
                      action="" method="post">
                    <div class="uk-grid" data-uk-grid-margin>
                        <div class="uk-width-medium-1-3">
                            <div class="parsley-row">
                                <label for="fullname">Message<span class="req">*</span></label>
