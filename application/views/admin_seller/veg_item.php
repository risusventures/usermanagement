                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="#" data-uk-tooltip="{pos:'bottom'}" Title="edit"
                                       data-uk-modal="{target:'#modal_header_footer_<?php echo $item['veg_id']; ?>'}"><i
                                                class="material-icons" style="font-size:28px;color:#1976D2;">�?</i></a>
                                    <div class="uk-modal" id="modal_header_footer_<?php echo $item['veg_id']; ?>"
                                        ...
                                        <input type="hidden" name="uid" class="md-input label-fixed"
                                               value="<?php echo $item['veg_id']; ?>" data-parsley-id="4">
                                                            ...
                                                            <div class="parsley-row">
                                                                <div class="md-input-wrapper md-input-filled"><label>Item
                                                                        Ammount<span class="req">*</span></label><input
                                                                            ...
                                                                            class="md-input label-fixed"
                                                                            value="<?php echo $item['veg_ammount']; ?>"
                                                                            data-parsley-id="4" required><span
                                                                            class="md-input-bar"></span></div>
                                                            </div>
                                                        </div>
                                    ...
                                    <a href="<?php echo site_url() ?>seller/delete_veg_item/<?php echo $item['veg_id']; ?>"
...
<div class="uk-modal" id="modal_header_footer_customers" aria-hidden="true" style="display: none; overflow-y: auto;">
    <?php echo form_open(site_url('seller/item_veg_submit'), array('id' => 'contactname', 'name' => 'contactname', 'class' => 'uk-form-stacked', 'enctype' => 'multipart/form-data', 'onsubmit' => 'return validateentry();')); ?>
    <div class="uk-modal-dialog" style="top: 88px;">
