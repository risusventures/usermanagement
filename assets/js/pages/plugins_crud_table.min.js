        ...
        init: function()
        {
                $("#students_crud")
                        .jtable(
                        {
                                ...
                                {
                                        t.deleteConfirmMessage = "Are you sure to delete student " + t.record.Name + "?"
                                },
                                formCreated: function(t, e)
                                {
                                        e.form.find(".jtable-option-text-clickable")
                                                ...
                                                {
                                                        $(this)
                                                                .addClass("md-input"), altair_forms.textarea_autosize()
                                                }), altair_md.inputs()
                                },
                                actions:
                                {
                                ...
                                fields:
                                {
                                        ...
                                        BirthDate:
                                        {
                                                ...
                                                input: function(t)
                                                {
                                                        return t.record ? '<input class="md-input" type="text" name="BirthDate" value="' + t.value +
                                                                "\" data-uk-datepicker=\"{format:'DD/MM/YYYY',addClass: 'dropdown-modal'}\"/>" :
                                                                '<input class="md-input" type="text" name="BirthDate"  value="" data-uk-datepicker="{format:\'DD/MM/YYYY\',addClass: \'dropdown-modal\'}"/>'
                                                }
                                        },
                                        Education:
                                        {
